...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.HistoricalSurveyData();
  });
  ...
  describe('HistoricalSurveyData', function() {
    it('should create an instance of HistoricalSurveyData', function() {
      // uncomment below and update the code to test HistoricalSurveyData
      //var instane = new uclapi.HistoricalSurveyData();
      //expect(instance).to.be.a(uclapi.HistoricalSurveyData);
    });
    ...
    it('should have the property sensorId (base name: "sensor_id")', function() {
      ...
      //var instance = new uclapi.HistoricalSurveyData();
