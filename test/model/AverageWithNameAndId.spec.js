...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.AverageWithNameAndId();
  });
  ...
  describe('AverageWithNameAndId', function() {
    it('should create an instance of AverageWithNameAndId', function() {
      // uncomment below and update the code to test AverageWithNameAndId
      //var instane = new uclapi.AverageWithNameAndId();
      //expect(instance).to.be.a(uclapi.AverageWithNameAndId);
    });

    it('should have the property sensorsAbsent (base name: "sensors_absent")', function() {
      // uncomment below and update the code to test the property sensorsAbsent
      //var instance = new uclapi.AverageWithNameAndId();
      //expect(instance).to.be();
    });

    it('should have the property sensorsTotal (base name: "sensors_total")', function() {
      // uncomment below and update the code to test the property sensorsTotal
      //var instance = new uclapi.AverageWithNameAndId();
      //expect(instance).to.be();
    });

    it('should have the property sensorsOccupied (base name: "sensors_occupied")', function() {
      // uncomment below and update the code to test the property sensorsOccupied
      //var instance = new uclapi.AverageWithNameAndId();
      //expect(instance).to.be();
    });
