...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SummerSchool();
  });
  ...
  describe('SummerSchool', function() {
    it('should create an instance of SummerSchool', function() {
      // uncomment below and update the code to test SummerSchool
      //var instane = new uclapi.SummerSchool();
      //expect(instance).to.be.a(uclapi.SummerSchool);
    });

    it('should have the property isSummerSchool (base name: "is_summer_school")', function() {
      // uncomment below and update the code to test the property isSummerSchool
      //var instance = new uclapi.SummerSchool();
