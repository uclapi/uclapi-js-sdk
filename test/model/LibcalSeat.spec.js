...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalSeat();
  });
  ...
  describe('LibcalSeat', function() {
    it('should create an instance of LibcalSeat', function() {
      // uncomment below and update the code to test LibcalSeat
      //var instane = new uclapi.LibcalSeat();
    ...
    it('should have the property isAccessible (base name: "is_accessible")', function() {
      // uncomment below and update the code to test the property isAccessible
      //var instance = new uclapi.LibcalSeat();
      //expect(instance).to.be();
    });

    it('should have the property isPowered (base name: "is_powered")', function() {
      // uncomment below and update the code to test the property isPowered
      //var instance = new uclapi.LibcalSeat();
      //expect(instance).to.be();
    });
