...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20041();
  });
  ...
  describe('InlineResponse20041', function() {
    it('should create an instance of InlineResponse20041', function() {
      ...
      //var instane = new uclapi.InlineResponse20041();
      //expect(instance).to.be.a(uclapi.InlineResponse20041);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20041();
