...
(function(root, factory) {
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instane = new uclapi.Event();
      //expect(instance).to.be.a(uclapi.Event);
    });

    it('should have the property location (base name: "location")', function() {
      // uncomment below and update the code to test the property location
      //var instance = new uclapi.Event();
    ...
    it('should have the property sessionType (base name: "session_type")', function() {
      // uncomment below and update the code to test the property sessionType
      //var instance = new uclapi.Event();
      //expect(instance).to.be();
    });

    it('should have the property sessionTypeStr (base name: "session_type_str")', function() {
      // uncomment below and update the code to test the property sessionTypeStr
      //var instance = new uclapi.Event();
      //expect(instance).to.be();
    });

    it('should have the property sessionGroup (base name: "session_group")', function() {
      // uncomment below and update the code to test the property sessionGroup
      //var instance = new uclapi.Event();
      //expect(instance).to.be();
    });
