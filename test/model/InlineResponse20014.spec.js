...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20014();
  });
  ...
  describe('InlineResponse20014', function() {
    it('should create an instance of InlineResponse20014', function() {
      ...
      //var instane = new uclapi.InlineResponse20014();
      //expect(instance).to.be.a(uclapi.InlineResponse20014);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20014();
