...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalPersonalSeatBooking();
  });
  ...
  describe('LibcalPersonalSeatBooking', function() {
    it('should create an instance of LibcalPersonalSeatBooking', function() {
      // uncomment below and update the code to test LibcalPersonalSeatBooking
      //var instane = new uclapi.LibcalPersonalSeatBooking();
      //expect(instance).to.be.a(uclapi.LibcalPersonalSeatBooking);
    });

    it('should have the property bookId (base name: "book_id")', function() {
      // uncomment below and update the code to test the property bookId
      //var instance = new uclapi.LibcalPersonalSeatBooking();
    ...
    it('should have the property checkInCode (base name: "check_in_code")', function() {
      // uncomment below and update the code to test the property checkInCode
      //var instance = new uclapi.LibcalPersonalSeatBooking();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lid (base name: "lid")', function() {
      // uncomment below and update the code to test the property lid
      //var instance = new uclapi.LibcalPersonalSeatBooking();
      //expect(instance).to.be();
    });
    ...
    it('should have the property seatId (base name: "seat_id")', function() {
      // uncomment below and update the code to test the property seatId
      //var instance = new uclapi.LibcalPersonalSeatBooking();
      //expect(instance).to.be();
    });

    it('should have the property seatName (base name: "seat_name")', function() {
      // uncomment below and update the code to test the property seatName
      //var instance = new uclapi.LibcalPersonalSeatBooking();
      //expect(instance).to.be();
    });
