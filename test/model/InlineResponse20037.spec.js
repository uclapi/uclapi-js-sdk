...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20037();
  });
  ...
  describe('InlineResponse20037', function() {
    it('should create an instance of InlineResponse20037', function() {
      ...
      //var instane = new uclapi.InlineResponse20037();
      //expect(instance).to.be.a(uclapi.InlineResponse20037);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20037();
