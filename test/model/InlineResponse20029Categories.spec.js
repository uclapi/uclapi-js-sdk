...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20029Categories();
  });
  ...
  describe('InlineResponse20029Categories', function() {
    it('should create an instance of InlineResponse20029Categories', function() {
      // uncomment below and update the code to test InlineResponse20029Categories
      //var instane = new uclapi.InlineResponse20029Categories();
      //expect(instance).to.be.a(uclapi.InlineResponse20029Categories);
    });

    it('should have the property cid (base name: "cid")', function() {
      // uncomment below and update the code to test the property cid
      //var instance = new uclapi.InlineResponse20029Categories();
