...
(function(root, factory) {
  ...
  describe('Svg', function() {
    it('should create an instance of Svg', function() {
      // uncomment below and update the code to test Svg
      //var instane = new uclapi.Svg();
      //expect(instance).to.be.a(uclapi.Svg);
    });

    it('should have the property xmlnsev (base name: "xmlns:ev")', function() {
      // uncomment below and update the code to test the property xmlnsev
      //var instance = new uclapi.Svg();
      //expect(instance).to.be();
    });

    it('should have the property xmlnsxlink (base name: "xmlns:xlink")', function() {
      // uncomment below and update the code to test the property xmlnsxlink
      //var instance = new uclapi.Svg();
      //expect(instance).to.be();
    });
