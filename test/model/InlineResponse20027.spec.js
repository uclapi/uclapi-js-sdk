...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20027();
  });
  ...
  describe('InlineResponse20027', function() {
    it('should create an instance of InlineResponse20027', function() {
      ...
      //var instane = new uclapi.InlineResponse20027();
      //expect(instance).to.be.a(uclapi.InlineResponse20027);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20027();
