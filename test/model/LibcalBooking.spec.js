...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalBooking();
  });
  ...
  describe('LibcalBooking', function() {
    it('should create an instance of LibcalBooking', function() {
      // uncomment below and update the code to test LibcalBooking
      //var instane = new uclapi.LibcalBooking();
      //expect(instance).to.be.a(uclapi.LibcalBooking);
    });
    ...
    it('should have the property nickname (base name: "nickname")', function() {
      ...
      //var instance = new uclapi.LibcalBooking();
