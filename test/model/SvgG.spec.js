...
(function(root, factory) {
  ...
  describe('SvgG', function() {
    it('should create an instance of SvgG', function() {
      // uncomment below and update the code to test SvgG
      //var instane = new uclapi.SvgG();
      //expect(instance).to.be.a(uclapi.SvgG);
    });
