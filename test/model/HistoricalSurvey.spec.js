...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.HistoricalSurvey();
  });
  ...
  describe('HistoricalSurvey', function() {
    it('should create an instance of HistoricalSurvey', function() {
      // uncomment below and update the code to test HistoricalSurvey
      //var instane = new uclapi.HistoricalSurvey();
      //expect(instance).to.be.a(uclapi.HistoricalSurvey);
    });
    ...
    it('should have the property surveyId (base name: "survey_id")', function() {
      ...
      //var instance = new uclapi.HistoricalSurvey();
