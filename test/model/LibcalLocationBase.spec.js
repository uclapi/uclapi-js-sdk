...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalLocationBase();
  });
  ...
  describe('LibcalLocationBase', function() {
    it('should create an instance of LibcalLocationBase', function() {
      // uncomment below and update the code to test LibcalLocationBase
      //var instane = new uclapi.LibcalLocationBase();
      //expect(instance).to.be.a(uclapi.LibcalLocationBase);
    });

    it('should have the property lid (base name: "lid")', function() {
      // uncomment below and update the code to test the property lid
      //var instance = new uclapi.LibcalLocationBase();
