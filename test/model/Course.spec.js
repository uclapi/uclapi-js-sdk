...
(function(root, factory) {
  ...
  describe('Course', function() {
    it('should create an instance of Course', function() {
      ...
      //var instane = new uclapi.Course();
      //expect(instance).to.be.a(uclapi.Course);
    });
    ...
    it('should have the property courseName (base name: "course_name")', function() {
      ...
      //var instance = new uclapi.Course();
      //expect(instance).to.be();
    });

    it('should have the property courseId (base name: "course_id")', function() {
