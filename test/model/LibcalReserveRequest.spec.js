...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalReserveRequest();
  });
  ...
  describe('LibcalReserveRequest', function() {
    it('should create an instance of LibcalReserveRequest', function() {
      // uncomment below and update the code to test LibcalReserveRequest
      //var instane = new uclapi.LibcalReserveRequest();
      //expect(instance).to.be.a(uclapi.LibcalReserveRequest);
    });

    it('should have the property start (base name: "start")', function() {
      // uncomment below and update the code to test the property start
      //var instance = new uclapi.LibcalReserveRequest();
