...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.DesktopDataLocation();
  });
  ...
  describe('DesktopDataLocation', function() {
    it('should create an instance of DesktopDataLocation', function() {
      // uncomment below and update the code to test DesktopDataLocation
      //var instane = new uclapi.DesktopDataLocation();
      //expect(instance).to.be.a(uclapi.DesktopDataLocation);
    });

    it('should have the property latitude (base name: "latitude")', function() {
      // uncomment below and update the code to test the property latitude
      //var instance = new uclapi.DesktopDataLocation();
