...
(function(root, factory) {
  ...
  describe('Booking', function() {
    it('should create an instance of Booking', function() {
      ...
      //var instane = new uclapi.Booking();
      //expect(instance).to.be.a(uclapi.Booking);
    });
    ...
    it('should have the property slotid (base name: "slotid")', function() {
      ...
      //var instance = new uclapi.Booking();
    ...
    it('should have the property weeknumber (base name: "weeknumber")', function() {
