...
(function(root, factory) {
  ...
  describe('Instance', function() {
    it('should create an instance of Instance', function() {
      ...
      //var instane = new uclapi.Instance();
      //expect(instance).to.be.a(uclapi.Instance);
    });

    it('should have the property fullModuleId (base name: "full_module_id")', function() {
      // uncomment below and update the code to test the property fullModuleId
      //var instance = new uclapi.Instance();
      //expect(instance).to.be();
    });

    it('should have the property classSize (base name: "class_size")', function() {
      // uncomment below and update the code to test the property classSize
      //var instance = new uclapi.Instance();
      //expect(instance).to.be();
    });
