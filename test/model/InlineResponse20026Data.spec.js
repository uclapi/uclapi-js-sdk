...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20026Data();
  });
  ...
  describe('InlineResponse20026Data', function() {
    it('should create an instance of InlineResponse20026Data', function() {
      // uncomment below and update the code to test InlineResponse20026Data
      //var instane = new uclapi.InlineResponse20026Data();
      //expect(instance).to.be.a(uclapi.InlineResponse20026Data);
    });
    ...
    it('should have the property department (base name: "department")', function() {
      ...
      //var instance = new uclapi.InlineResponse20026Data();
