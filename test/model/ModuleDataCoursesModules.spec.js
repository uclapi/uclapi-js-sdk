...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.ModuleDataCoursesModules();
  });
  ...
  describe('ModuleDataCoursesModules', function() {
    it('should create an instance of ModuleDataCoursesModules', function() {
      // uncomment below and update the code to test ModuleDataCoursesModules
      //var instane = new uclapi.ModuleDataCoursesModules();
      //expect(instance).to.be.a(uclapi.ModuleDataCoursesModules);
    });
    ...
    it('should have the property moduleId (base name: "module_id")', function() {
      ...
      //var instance = new uclapi.ModuleDataCoursesModules();
