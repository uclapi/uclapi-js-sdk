...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalSeatBooking();
  });
  ...
  describe('LibcalSeatBooking', function() {
    it('should create an instance of LibcalSeatBooking', function() {
      // uncomment below and update the code to test LibcalSeatBooking
      //var instane = new uclapi.LibcalSeatBooking();
      //expect(instance).to.be.a(uclapi.LibcalSeatBooking);
    });

    it('should have the property eid (base name: "eid")', function() {
      // uncomment below and update the code to test the property eid
      //var instance = new uclapi.LibcalSeatBooking();
