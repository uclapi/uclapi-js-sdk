...
(function(root, factory) {
  ...
  describe('Delivery', function() {
    it('should create an instance of Delivery', function() {
      ...
      //var instane = new uclapi.Delivery();
      //expect(instance).to.be.a(uclapi.Delivery);
    });

    it('should have the property fheqLevel (base name: "fheq_level")', function() {
      // uncomment below and update the code to test the property fheqLevel
      //var instance = new uclapi.Delivery();
      //expect(instance).to.be();
    });

    it('should have the property isUndergraduate (base name: "is_undergraduate")', function() {
      // uncomment below and update the code to test the property isUndergraduate
      //var instance = new uclapi.Delivery();
      //expect(instance).to.be();
    });

    it('should have the property studentType (base name: "student_type")', function() {
      // uncomment below and update the code to test the property studentType
      //var instance = new uclapi.Delivery();
      //expect(instance).to.be();
    });
