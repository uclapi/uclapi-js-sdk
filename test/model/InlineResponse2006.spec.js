...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse2006();
  });
  ...
  describe('InlineResponse2006', function() {
    it('should create an instance of InlineResponse2006', function() {
      ...
      //var instane = new uclapi.InlineResponse2006();
      //expect(instance).to.be.a(uclapi.InlineResponse2006);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse2006();
