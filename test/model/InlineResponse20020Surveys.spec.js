...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20020Surveys();
  });
  ...
  describe('InlineResponse20020Surveys', function() {
    it('should create an instance of InlineResponse20020Surveys', function() {
      // uncomment below and update the code to test InlineResponse20020Surveys
      //var instane = new uclapi.InlineResponse20020Surveys();
      //expect(instance).to.be.a(uclapi.InlineResponse20020Surveys);
    });

    it('should have the property next (base name: "next")', function() {
      // uncomment below and update the code to test the property next
      //var instance = new uclapi.InlineResponse20020Surveys();
