...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SensorAverageSurvey();
  });
  ...
  describe('SensorAverageSurvey', function() {
    it('should create an instance of SensorAverageSurvey', function() {
      // uncomment below and update the code to test SensorAverageSurvey
      //var instane = new uclapi.SensorAverageSurvey();
      //expect(instance).to.be.a(uclapi.SensorAverageSurvey);
    });
    ...
    it('should have the property surveyId (base name: "survey_id")', function() {
      ...
      //var instance = new uclapi.SensorAverageSurvey();
