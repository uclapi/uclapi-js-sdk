...
(function(root, factory) {
  ...
  describe('SvgGImage', function() {
    it('should create an instance of SvgGImage', function() {
      // uncomment below and update the code to test SvgGImage
      //var instane = new uclapi.SvgGImage();
      //expect(instance).to.be.a(uclapi.SvgGImage);
    });

    it('should have the property width (base name: "width")', function() {
      // uncomment below and update the code to test the property width
      //var instance = new uclapi.SvgGImage();
    ...
    it('should have the property xlinkhref (base name: "xlink:href")', function() {
      // uncomment below and update the code to test the property xlinkhref
      //var instance = new uclapi.SvgGImage();
      //expect(instance).to.be();
    });
