...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse2009();
  });
  ...
  describe('InlineResponse2009', function() {
    it('should create an instance of InlineResponse2009', function() {
      ...
      //var instane = new uclapi.InlineResponse2009();
      //expect(instance).to.be.a(uclapi.InlineResponse2009);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse2009();
    ...
    it('should have the property freeRooms (base name: "free_rooms")', function() {
      // uncomment below and update the code to test the property freeRooms
      //var instance = new uclapi.InlineResponse2009();
      //expect(instance).to.be();
    });
