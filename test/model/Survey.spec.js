...
(function(root, factory) {
  ...
  describe('Survey', function() {
    it('should create an instance of Survey', function() {
      ...
      //var instane = new uclapi.Survey();
      //expect(instance).to.be.a(uclapi.Survey);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new uclapi.Survey();
    ...
    it('should have the property staffSurvey (base name: "staff_survey")', function() {
      // uncomment below and update the code to test the property staffSurvey
      //var instance = new uclapi.Survey();
      //expect(instance).to.be();
    });
