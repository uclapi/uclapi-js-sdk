...
(function(root, factory) {
  ...
  describe('Average', function() {
    it('should create an instance of Average', function() {
      // uncomment below and update the code to test Average
      //var instane = new uclapi.Average();
      //expect(instance).to.be.a(uclapi.Average);
    });
    ...
    it('should have the property sensorsAbsent (base name: "sensors_absent")', function() {
      ...
      //var instance = new uclapi.Average();
