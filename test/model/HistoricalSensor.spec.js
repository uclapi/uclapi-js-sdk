...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.HistoricalSensor();
  });
  ...
  describe('HistoricalSensor', function() {
    it('should create an instance of HistoricalSensor', function() {
      // uncomment below and update the code to test HistoricalSensor
      //var instane = new uclapi.HistoricalSensor();
      //expect(instance).to.be.a(uclapi.HistoricalSensor);
    });
    ...
    it('should have the property surveyId (base name: "survey_id")', function() {
      ...
      //var instance = new uclapi.HistoricalSensor();
      //expect(instance).to.be();
    });

    it('should have the property sensorId (base name: "sensor_id")', function() {
