...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20012();
  });
  ...
  describe('InlineResponse20012', function() {
    it('should create an instance of InlineResponse20012', function() {
      ...
      //var instane = new uclapi.InlineResponse20012();
      //expect(instance).to.be.a(uclapi.InlineResponse20012);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20012();
