...
(function(root, factory) {
  ...
  describe('Room', function() {
    it('should create an instance of Room', function() {
      ...
      //var instane = new uclapi.Room();
      //expect(instance).to.be.a(uclapi.Room);
    });
    ...
    it('should have the property classificationName (base name: "classification_name")', function() {
      // uncomment below and update the code to test the property classificationName
      //var instance = new uclapi.Room();
      //expect(instance).to.be();
    });

    it('should have the property automated (base name: "automated")', function() {
      // uncomment below and update the code to test the property automated
      //var instance = new uclapi.Room();
      //expect(instance).to.be();
    });
