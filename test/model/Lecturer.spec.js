...
(function(root, factory) {
  ...
  describe('Lecturer', function() {
    it('should create an instance of Lecturer', function() {
      // uncomment below and update the code to test Lecturer
      //var instane = new uclapi.Lecturer();
      //expect(instance).to.be.a(uclapi.Lecturer);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new uclapi.Lecturer();
