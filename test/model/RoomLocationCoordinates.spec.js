...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.RoomLocationCoordinates();
  });
  ...
  describe('RoomLocationCoordinates', function() {
    it('should create an instance of RoomLocationCoordinates', function() {
      // uncomment below and update the code to test RoomLocationCoordinates
      //var instane = new uclapi.RoomLocationCoordinates();
      //expect(instance).to.be.a(uclapi.RoomLocationCoordinates);
    });

    it('should have the property lat (base name: "lat")', function() {
      // uncomment below and update the code to test the property lat
      //var instance = new uclapi.RoomLocationCoordinates();
