...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse2007();
  });
  ...
  describe('InlineResponse2007', function() {
    it('should create an instance of InlineResponse2007', function() {
      ...
      //var instane = new uclapi.InlineResponse2007();
      //expect(instance).to.be.a(uclapi.InlineResponse2007);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse2007();
      //expect(instance).to.be();
    });

    it('should have the property nextPageExists (base name: "next_page_exists")', function() {
      // uncomment below and update the code to test the property nextPageExists
      //var instance = new uclapi.InlineResponse2007();
      //expect(instance).to.be();
    });

    it('should have the property pageToken (base name: "page_token")', function() {
