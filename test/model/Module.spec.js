...
(function(root, factory) {
  ...
  describe('Module', function() {
    it('should create an instance of Module', function() {
      ...
      //var instane = new uclapi.Module();
      //expect(instance).to.be.a(uclapi.Module);
    });

    it('should have the property lecturer (base name: "lecturer")', function() {
      // uncomment below and update the code to test the property lecturer
      //var instance = new uclapi.Module();
