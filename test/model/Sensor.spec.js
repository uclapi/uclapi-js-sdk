...
(function(root, factory) {
  ...
  describe('Sensor', function() {
    it('should create an instance of Sensor', function() {
      ...
      //var instane = new uclapi.Sensor();
      //expect(instance).to.be.a(uclapi.Sensor);
    });

    it('should have the property description2 (base name: "description_2")', function() {
      // uncomment below and update the code to test the property description2
      //var instance = new uclapi.Sensor();
    ...
    it('should have the property yPos (base name: "y_pos")', function() {
      // uncomment below and update the code to test the property yPos
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property description3 (base name: "description_3")', function() {
      // uncomment below and update the code to test the property description3
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });
    ...
    it('should have the property hostAddress (base name: "host_address")', function() {
    ...
    it('should have the property roomDescription (base name: "room_description")', function() {
      // uncomment below and update the code to test the property roomDescription
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property lastTriggerType (base name: "last_trigger_type")', function() {
      // uncomment below and update the code to test the property lastTriggerType
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property surveyId (base name: "survey_id")', function() {
    ...
    it('should have the property surveyDeviceId (base name: "survey_device_id")', function() {
      // uncomment below and update the code to test the property surveyDeviceId
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property shareId (base name: "share_id")', function() {
      // uncomment below and update the code to test the property shareId
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property xPos (base name: "x_pos")', function() {
      // uncomment below and update the code to test the property xPos
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property description1 (base name: "description_1")', function() {
      // uncomment below and update the code to test the property description1
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property hardwareId (base name: "hardware_id")', function() {
      // uncomment below and update the code to test the property hardwareId
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property pirAddress (base name: "pir_address")', function() {
      // uncomment below and update the code to test the property pirAddress
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });

    it('should have the property lastTriggerTimestamp (base name: "last_trigger_timestamp")', function() {
      // uncomment below and update the code to test the property lastTriggerTimestamp
      //var instance = new uclapi.Sensor();
      //expect(instance).to.be();
    });
