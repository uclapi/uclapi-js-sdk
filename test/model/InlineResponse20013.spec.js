...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20013();
  });
  ...
  describe('InlineResponse20013', function() {
    it('should create an instance of InlineResponse20013', function() {
      ...
      //var instane = new uclapi.InlineResponse20013();
      //expect(instance).to.be.a(uclapi.InlineResponse20013);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20013();
      //expect(instance).to.be();
    });

    it('should have the property surveyName (base name: "survey_name")', function() {
