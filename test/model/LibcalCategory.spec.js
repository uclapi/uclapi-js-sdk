...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalCategory();
  });
  ...
  describe('LibcalCategory', function() {
    it('should create an instance of LibcalCategory', function() {
      // uncomment below and update the code to test LibcalCategory
      //var instane = new uclapi.LibcalCategory();
    ...
    it('should have the property cid (base name: "cid")', function() {
      ...
      //var instance = new uclapi.LibcalCategory();
