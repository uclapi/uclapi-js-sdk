...
(function(root, factory) {
  ...
  describe('UserData', function() {
    ...
    it('should have the property scopeNumber (base name: "scope_number")', function() {
      // uncomment below and update the code to test the property scopeNumber
      //var instance = new uclapi.UserData();
      //expect(instance).to.be();
    });

    it('should have the property isStudent (base name: "is_student")', function() {
      // uncomment below and update the code to test the property isStudent
      //var instance = new uclapi.UserData();
      //expect(instance).to.be();
    });

    it('should have the property uclGroups (base name: "ucl_groups")', function() {
      // uncomment below and update the code to test the property uclGroups
      //var instance = new uclapi.UserData();
      //expect(instance).to.be();
    });
