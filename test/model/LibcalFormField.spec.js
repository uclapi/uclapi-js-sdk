...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalFormField();
  });
  ...
  describe('LibcalFormField', function() {
    it('should create an instance of LibcalFormField', function() {
      // uncomment below and update the code to test LibcalFormField
      //var instane = new uclapi.LibcalFormField();
      //expect(instance).to.be.a(uclapi.LibcalFormField);
    });

    it('should have the property label (base name: "label")', function() {
      // uncomment below and update the code to test the property label
      //var instance = new uclapi.LibcalFormField();
