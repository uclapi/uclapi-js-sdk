...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20026();
  });
  ...
  describe('InlineResponse20026', function() {
    it('should create an instance of InlineResponse20026', function() {
      ...
      //var instane = new uclapi.InlineResponse20026();
      //expect(instance).to.be.a(uclapi.InlineResponse20026);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20026();
