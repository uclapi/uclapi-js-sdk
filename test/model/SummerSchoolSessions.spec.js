...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SummerSchoolSessions();
  });
  ...
  describe('SummerSchoolSessions', function() {
    it('should create an instance of SummerSchoolSessions', function() {
      // uncomment below and update the code to test SummerSchoolSessions
      //var instane = new uclapi.SummerSchoolSessions();
      //expect(instance).to.be.a(uclapi.SummerSchoolSessions);
    });

    it('should have the property session1 (base name: "session_1")', function() {
      // uncomment below and update the code to test the property session1
      //var instance = new uclapi.SummerSchoolSessions();
      //expect(instance).to.be();
    });

    it('should have the property session2 (base name: "session_2")', function() {
      // uncomment below and update the code to test the property session2
      //var instance = new uclapi.SummerSchoolSessions();
      //expect(instance).to.be();
    });
