...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalUtilisationSpaceSummary();
  });
  ...
  describe('LibcalUtilisationSpaceSummary', function() {
    it('should create an instance of LibcalUtilisationSpaceSummary', function() {
      // uncomment below and update the code to test LibcalUtilisationSpaceSummary
      //var instane = new uclapi.LibcalUtilisationSpaceSummary();
      //expect(instance).to.be.a(uclapi.LibcalUtilisationSpaceSummary);
    });

    it('should have the property active (base name: "active")', function() {
      // uncomment below and update the code to test the property active
      //var instance = new uclapi.LibcalUtilisationSpaceSummary();
      //expect(instance).to.be();
    });

    it('should have the property bookableCount (base name: "bookable_count")', function() {
      // uncomment below and update the code to test the property bookableCount
      //var instance = new uclapi.LibcalUtilisationSpaceSummary();
      //expect(instance).to.be();
    });
