...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalLocation();
  });
  ...
  describe('LibcalLocation', function() {
    it('should create an instance of LibcalLocation', function() {
      // uncomment below and update the code to test LibcalLocation
      //var instane = new uclapi.LibcalLocation();
      //expect(instance).to.be.a(uclapi.LibcalLocation);
    });
    ...
    it('should have the property _public (base name: "public")', function() {
      ...
      //var instance = new uclapi.LibcalLocation();
