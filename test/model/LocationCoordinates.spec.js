...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LocationCoordinates();
  });
  ...
  describe('LocationCoordinates', function() {
    it('should create an instance of LocationCoordinates', function() {
      // uncomment below and update the code to test LocationCoordinates
      //var instane = new uclapi.LocationCoordinates();
      //expect(instance).to.be.a(uclapi.LocationCoordinates);
    });

    it('should have the property lat (base name: "lat")', function() {
      // uncomment below and update the code to test the property lat
      //var instance = new uclapi.LocationCoordinates();
