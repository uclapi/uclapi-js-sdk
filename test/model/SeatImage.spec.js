...
(function(root, factory) {
  ...
  describe('SeatImage', function() {
    it('should create an instance of SeatImage', function() {
      // uncomment below and update the code to test SeatImage
      //var instane = new uclapi.SeatImage();
      //expect(instance).to.be.a(uclapi.SeatImage);
    });
    ...
    it('should have the property transform (base name: "transform")', function() {
      ...
      //var instance = new uclapi.SeatImage();
