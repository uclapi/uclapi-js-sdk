...
(function(root, factory) {
  ...
  describe('Period', function() {
    it('should create an instance of Period', function() {
      ...
      //var instane = new uclapi.Period();
      //expect(instance).to.be.a(uclapi.Period);
    });

    it('should have the property teachingPeriods (base name: "teaching_periods")', function() {
      // uncomment below and update the code to test the property teachingPeriods
      //var instance = new uclapi.Period();
      //expect(instance).to.be();
    });

    it('should have the property yearLong (base name: "year_long")', function() {
      // uncomment below and update the code to test the property yearLong
      //var instance = new uclapi.Period();
      //expect(instance).to.be();
    });

    it('should have the property lsr (base name: "lsr")', function() {
      // uncomment below and update the code to test the property lsr
      //var instance = new uclapi.Period();
      //expect(instance).to.be();
    });

    it('should have the property summerSchool (base name: "summer_school")', function() {
      // uncomment below and update the code to test the property summerSchool
      //var instance = new uclapi.Period();
      //expect(instance).to.be();
    });
