...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.TeachingPeriods();
  });
  ...
  describe('TeachingPeriods', function() {
    it('should create an instance of TeachingPeriods', function() {
      // uncomment below and update the code to test TeachingPeriods
      //var instane = new uclapi.TeachingPeriods();
      //expect(instance).to.be.a(uclapi.TeachingPeriods);
    });

    it('should have the property term1 (base name: "term_1")', function() {
      // uncomment below and update the code to test the property term1
      //var instance = new uclapi.TeachingPeriods();
      //expect(instance).to.be();
    });

    it('should have the property term2 (base name: "term_2")', function() {
      // uncomment below and update the code to test the property term2
      //var instance = new uclapi.TeachingPeriods();
      //expect(instance).to.be();
    });

    it('should have the property term3 (base name: "term_3")', function() {
      // uncomment below and update the code to test the property term3
      //var instance = new uclapi.TeachingPeriods();
      //expect(instance).to.be();
    });

    it('should have the property term1NextYear (base name: "term_1_next_year")', function() {
      // uncomment below and update the code to test the property term1NextYear
      //var instance = new uclapi.TeachingPeriods();
      //expect(instance).to.be();
    });
