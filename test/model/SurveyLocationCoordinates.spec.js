...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SurveyLocationCoordinates();
  });
  ...
  describe('SurveyLocationCoordinates', function() {
    it('should create an instance of SurveyLocationCoordinates', function() {
      // uncomment below and update the code to test SurveyLocationCoordinates
      //var instane = new uclapi.SurveyLocationCoordinates();
      //expect(instance).to.be.a(uclapi.SurveyLocationCoordinates);
    });

    it('should have the property lat (base name: "lat")', function() {
      // uncomment below and update the code to test the property lat
      //var instance = new uclapi.SurveyLocationCoordinates();
