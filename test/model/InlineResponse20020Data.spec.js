...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20020Data();
  });
  ...
  describe('InlineResponse20020Data', function() {
    it('should create an instance of InlineResponse20020Data', function() {
      // uncomment below and update the code to test InlineResponse20020Data
      //var instane = new uclapi.InlineResponse20020Data();
      //expect(instance).to.be.a(uclapi.InlineResponse20020Data);
    });
    ...
    it('should have the property service (base name: "service")', function() {
      ...
      //var instance = new uclapi.InlineResponse20020Data();
