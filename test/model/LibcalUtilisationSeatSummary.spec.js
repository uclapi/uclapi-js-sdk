...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalUtilisationSeatSummary();
  });
  ...
  describe('LibcalUtilisationSeatSummary', function() {
    it('should create an instance of LibcalUtilisationSeatSummary', function() {
      // uncomment below and update the code to test LibcalUtilisationSeatSummary
    ...
    it('should have the property active (base name: "active")', function() {
      ...
      //var instance = new uclapi.LibcalUtilisationSeatSummary();
