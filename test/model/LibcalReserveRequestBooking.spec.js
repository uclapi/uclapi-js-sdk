...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.LibcalReserveRequestBooking();
  });
  ...
  describe('LibcalReserveRequestBooking', function() {
    it('should create an instance of LibcalReserveRequestBooking', function() {
      // uncomment below and update the code to test LibcalReserveRequestBooking
      //var instane = new uclapi.LibcalReserveRequestBooking();
      //expect(instance).to.be.a(uclapi.LibcalReserveRequestBooking);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new uclapi.LibcalReserveRequestBooking();
