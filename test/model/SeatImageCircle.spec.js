...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SeatImageCircle();
  });
  ...
  describe('SeatImageCircle', function() {
    it('should create an instance of SeatImageCircle', function() {
      // uncomment below and update the code to test SeatImageCircle
      //var instane = new uclapi.SeatImageCircle();
      //expect(instance).to.be.a(uclapi.SeatImageCircle);
    });

    it('should have the property r (base name: "r")', function() {
      // uncomment below and update the code to test the property r
      //var instance = new uclapi.SeatImageCircle();
