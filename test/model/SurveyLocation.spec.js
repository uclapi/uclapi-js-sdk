...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.SurveyLocation();
  });
  ...
  describe('SurveyLocation', function() {
    it('should create an instance of SurveyLocation', function() {
      // uncomment below and update the code to test SurveyLocation
      //var instane = new uclapi.SurveyLocation();
      //expect(instance).to.be.a(uclapi.SurveyLocation);
    });
    ...
    it('should have the property coordinates (base name: "coordinates")', function() {
      ...
      //var instance = new uclapi.SurveyLocation();
