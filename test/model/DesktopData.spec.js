...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.DesktopData();
  });
  ...
  describe('DesktopData', function() {
    it('should create an instance of DesktopData', function() {
      // uncomment below and update the code to test DesktopData
      //var instane = new uclapi.DesktopData();
      //expect(instance).to.be.a(uclapi.DesktopData);
    });
    ...
    it('should have the property roomStatus (base name: "room_status")', function() {
      ...
      //var instance = new uclapi.DesktopData();
      //expect(instance).to.be();
    });

    it('should have the property totalSeats (base name: "total_seats")', function() {
      // uncomment below and update the code to test the property totalSeats
      //var instance = new uclapi.DesktopData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property freeSeats (base name: "free_seats")', function() {
      // uncomment below and update the code to test the property freeSeats
      //var instance = new uclapi.DesktopData();
      //expect(instance).to.be();
    });
