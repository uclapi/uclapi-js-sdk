...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.InlineResponse20024();
  });
  ...
  describe('InlineResponse20024', function() {
    it('should create an instance of InlineResponse20024', function() {
      ...
      //var instane = new uclapi.InlineResponse20024();
      //expect(instance).to.be.a(uclapi.InlineResponse20024);
    });

    it('should have the property ok (base name: "ok")', function() {
      // uncomment below and update the code to test the property ok
      //var instance = new uclapi.InlineResponse20024();
