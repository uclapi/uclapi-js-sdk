...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.AnalyticsApi();
  });
  ...
  describe('AnalyticsApi', function() {
    describe('dashboardApiAnalyticsMethodsGet', function() {
      it('should call dashboardApiAnalyticsMethodsGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsMethodsGet
        //instance.dashboardApiAnalyticsMethodsGet(function(error) {
    ...
    describe('dashboardApiAnalyticsOauthTotalByDeptGet', function() {
      it('should call dashboardApiAnalyticsOauthTotalByDeptGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsOauthTotalByDeptGet
        //instance.dashboardApiAnalyticsOauthTotalByDeptGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dashboardApiAnalyticsOauthTotalGet', function() {
      it('should call dashboardApiAnalyticsOauthTotalGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsOauthTotalGet
        //instance.dashboardApiAnalyticsOauthTotalGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dashboardApiAnalyticsQuotaGet', function() {
      it('should call dashboardApiAnalyticsQuotaGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsQuotaGet
        //instance.dashboardApiAnalyticsQuotaGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dashboardApiAnalyticsServicesGet', function() {
      it('should call dashboardApiAnalyticsServicesGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsServicesGet
        //instance.dashboardApiAnalyticsServicesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dashboardApiAnalyticsTotalGet', function() {
      it('should call dashboardApiAnalyticsTotalGet successfully', function(done) {
        //uncomment below and update the code to test dashboardApiAnalyticsTotalGet
        //instance.dashboardApiAnalyticsTotalGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
