...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.TimetableApi();
  });
  ...
  describe('TimetableApi', function() {
    describe('timetableBymoduleGet', function() {
      it('should call timetableBymoduleGet successfully', function(done) {
        //uncomment below and update the code to test timetableBymoduleGet
        //instance.timetableBymoduleGet(function(error) {
    ...
    describe('timetableDataCoursesGet', function() {
      it('should call timetableDataCoursesGet successfully', function(done) {
        //uncomment below and update the code to test timetableDataCoursesGet
        //instance.timetableDataCoursesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('timetableDataCoursesModulesGet', function() {
      it('should call timetableDataCoursesModulesGet successfully', function(done) {
        //uncomment below and update the code to test timetableDataCoursesModulesGet
        //instance.timetableDataCoursesModulesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('timetableDataDepartmentsGet', function() {
      it('should call timetableDataDepartmentsGet successfully', function(done) {
        //uncomment below and update the code to test timetableDataDepartmentsGet
        //instance.timetableDataDepartmentsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('timetableDataModulesGet', function() {
      it('should call timetableDataModulesGet successfully', function(done) {
        //uncomment below and update the code to test timetableDataModulesGet
        //instance.timetableDataModulesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('timetablePersonalGet', function() {
      it('should call timetablePersonalGet successfully', function(done) {
        //uncomment below and update the code to test timetablePersonalGet
        //instance.timetablePersonalGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
