...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.RoomBookingsApi();
  });
  ...
  describe('RoomBookingsApi', function() {
    describe('roombookingsBookingsGet', function() {
      it('should call roombookingsBookingsGet successfully', function(done) {
        //uncomment below and update the code to test roombookingsBookingsGet
        //instance.roombookingsBookingsGet(function(error) {
    ...
    describe('roombookingsEquipmentGet', function() {
      it('should call roombookingsEquipmentGet successfully', function(done) {
        //uncomment below and update the code to test roombookingsEquipmentGet
        //instance.roombookingsEquipmentGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('roombookingsFreeroomsGet', function() {
      it('should call roombookingsFreeroomsGet successfully', function(done) {
        //uncomment below and update the code to test roombookingsFreeroomsGet
        //instance.roombookingsFreeroomsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('roombookingsRoomsGet', function() {
      it('should call roombookingsRoomsGet successfully', function(done) {
        //uncomment below and update the code to test roombookingsRoomsGet
        //instance.roombookingsRoomsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
