...
(function(root, factory) {
  ...
  describe('OAuthApi', function() {
    describe('oauthAuthoriseGet', function() {
      it('should call oauthAuthoriseGet successfully', function(done) {
        //uncomment below and update the code to test oauthAuthoriseGet
        //instance.oauthAuthoriseGet(function(error) {
    ...
    describe('oauthTokenGet', function() {
      it('should call oauthTokenGet successfully', function(done) {
        //uncomment below and update the code to test oauthTokenGet
        //instance.oauthTokenGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('oauthUserDataGet', function() {
      it('should call oauthUserDataGet successfully', function(done) {
        //uncomment below and update the code to test oauthUserDataGet
        //instance.oauthUserDataGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('oauthUserStudentnumberGet', function() {
      it('should call oauthUserStudentnumberGet successfully', function(done) {
        //uncomment below and update the code to test oauthUserStudentnumberGet
        //instance.oauthUserStudentnumberGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
