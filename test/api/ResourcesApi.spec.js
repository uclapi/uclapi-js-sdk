...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new uclapi.ResourcesApi();
  });
  ...
  describe('ResourcesApi', function() {
    describe('resourcesDesktopsGet', function() {
      it('should call resourcesDesktopsGet successfully', function(done) {
        //uncomment below and update the code to test resourcesDesktopsGet
        //instance.resourcesDesktopsGet(function(error) {
