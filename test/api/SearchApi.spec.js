...
(function(root, factory) {
  ...
  describe('SearchApi', function() {
    describe('searchPeopleGet', function() {
      it('should call searchPeopleGet successfully', function(done) {
        //uncomment below and update the code to test searchPeopleGet
        //instance.searchPeopleGet(function(error) {
