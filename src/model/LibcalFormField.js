...
/**
 * The LibcalFormField model module.
 * @module model/LibcalFormField
 * @version 1.4.2
 */
class LibcalFormField {
    /**
     * Constructs a new <code>LibcalFormField</code>.
     * @alias module:model/LibcalFormField
     */
    constructor() { 
        
        LibcalFormField.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalFormField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalFormField} obj Optional instance to populate.
     * @return {module:model/LibcalFormField} The populated <code>LibcalFormField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalFormField();
...
/**
 * Label for the field in the LibCal booking form
 * @member {String} label
 */
LibcalFormField.prototype['label'] = undefined;

/**
 * Field type for the field in the LibCal booking form. Examples of field types include 'string' and 'dropdown'.
 * @member {String} type
 */
LibcalFormField.prototype['type'] = undefined;

/**
 * Whether the field in the LibCal booking form is required (true) or optional (false)
 * @member {Boolean} required
 */
LibcalFormField.prototype['required'] = undefined;

/**
 * Array of options that will be provided if the field type is dropdown
 * @member {Array.<String>} options
 */
LibcalFormField.prototype['options'] = undefined;
...
export default LibcalFormField;
