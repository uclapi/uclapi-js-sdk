...
class Module {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lecturer')) {
                obj['lecturer'] = Lecturer.constructFromObject(data['lecturer']);
            }
...
/**
 * @member {module:model/Lecturer} lecturer
 */
Module.prototype['lecturer'] = undefined;

/**
 * Module ID.
 * @member {String} module_id
 */
Module.prototype['module_id'] = undefined;
 ...
 */
Module.prototype['department_id'] = undefined;

/**
 * Human readable department name that owns the module.
 * @member {String} department_name
 */
Module.prototype['department_name'] = undefined;
