...
/**
 * The RoomLocationCoordinates model module.
 * @module model/RoomLocationCoordinates
 * @version 1.1.0
 */
class RoomLocationCoordinates {
    /**
     * Constructs a new <code>RoomLocationCoordinates</code>.
     * @alias module:model/RoomLocationCoordinates
     */
    constructor() { 
        
        RoomLocationCoordinates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RoomLocationCoordinates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoomLocationCoordinates} obj Optional instance to populate.
     * @return {module:model/RoomLocationCoordinates} The populated <code>RoomLocationCoordinates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoomLocationCoordinates();
 ...
 * @member {Number} lat
 */
RoomLocationCoordinates.prototype['lat'] = undefined;

/**
 * @member {Number} lng
 */
RoomLocationCoordinates.prototype['lng'] = undefined;
...
export default RoomLocationCoordinates;
