...
/**
 * The LibcalSpaceBase model module.
 * @module model/LibcalSpaceBase
 * @version 1.4.9
 */
class LibcalSpaceBase {
    /**
     * Constructs a new <code>LibcalSpaceBase</code>.
     * @alias module:model/LibcalSpaceBase
     */
    constructor() { 
        
        LibcalSpaceBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalSpaceBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalSpaceBase} obj Optional instance to populate.
     * @return {module:model/LibcalSpaceBase} The populated <code>LibcalSpaceBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalSpaceBase();
 ...
 * @member {Number} id
 */
LibcalSpaceBase.prototype['id'] = undefined;

/**
 * Name of this LibCal space
 * @member {String} name
 */
LibcalSpaceBase.prototype['name'] = undefined;

/**
 * Description of this LibCal space
 * @member {String} description
 */
LibcalSpaceBase.prototype['description'] = undefined;

/**
 * URL pointing to an image depicting this LibCal space
 * @member {String} image
 */
LibcalSpaceBase.prototype['image'] = undefined;

/**
 * Maximum number of persons this LibCal space can accommodate
 * @member {Number} capacity
 */
LibcalSpaceBase.prototype['capacity'] = undefined;

/**
 * ID of the form associated with this LibCal space
 * @member {Number} formid
 */
LibcalSpaceBase.prototype['formid'] = undefined;
...
export default LibcalSpaceBase;
