...
import ModuleDataCoursesModules from './ModuleDataCoursesModules';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('modules')) {
                obj['modules'] = ApiClient.convertToType(data['modules'], {'String': ModuleDataCoursesModules});
            }
        }
        return obj;
    }
...
/**
 * @member {Object.<String, module:model/ModuleDataCoursesModules>} modules
 */
InlineResponse2002.prototype['modules'] = undefined;
