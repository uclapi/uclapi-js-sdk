...
/**
 * The Svg model module.
 * @module model/Svg
 * @version 1.4.8
 */
class Svg {
    /**
     * Constructs a new <code>Svg</code>.
     * @alias module:model/Svg
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Svg</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Svg} obj Optional instance to populate.
     * @return {module:model/Svg} The populated <code>Svg</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Svg();

            if (data.hasOwnProperty('xmlns:ev')) {
                obj['xmlns:ev'] = ApiClient.convertToType(data['xmlns:ev'], 'String');
            }
            if (data.hasOwnProperty('xmlns:xlink')) {
                obj['xmlns:xlink'] = ApiClient.convertToType(data['xmlns:xlink'], 'String');
            }
            if (data.hasOwnProperty('xmlns')) {
                obj['xmlns'] = ApiClient.convertToType(data['xmlns'], 'String');
            }
            if (data.hasOwnProperty('g')) {
                obj['g'] = SvgG.constructFromObject(data['g']);
            }
        }
        return obj;
    }
...
/**
 * @member {String} xmlns:ev
 */
Svg.prototype['xmlns:ev'] = undefined;

/**
 * @member {String} xmlns:xlink
 */
Svg.prototype['xmlns:xlink'] = undefined;

/**
 * @member {String} xmlns
 */
Svg.prototype['xmlns'] = undefined;

/**
 * @member {module:model/SvgG} g
 */
Svg.prototype['g'] = undefined;
