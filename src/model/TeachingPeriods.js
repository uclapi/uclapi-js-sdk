...
/**
 * The TeachingPeriods model module.
 * @module model/TeachingPeriods
 * @version 1.4.7
 */
class TeachingPeriods {
    /**
     * Constructs a new <code>TeachingPeriods</code>.
     * @alias module:model/TeachingPeriods
     */
    constructor() { 
        
        TeachingPeriods.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TeachingPeriods</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TeachingPeriods} obj Optional instance to populate.
     * @return {module:model/TeachingPeriods} The populated <code>TeachingPeriods</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TeachingPeriods();

            if (data.hasOwnProperty('term_1')) {
                obj['term_1'] = ApiClient.convertToType(data['term_1'], 'Boolean');
            }
            if (data.hasOwnProperty('term_2')) {
                obj['term_2'] = ApiClient.convertToType(data['term_2'], 'Boolean');
            }
            if (data.hasOwnProperty('term_3')) {
                obj['term_3'] = ApiClient.convertToType(data['term_3'], 'Boolean');
            }
            if (data.hasOwnProperty('term_1_next_year')) {
                obj['term_1_next_year'] = ApiClient.convertToType(data['term_1_next_year'], 'Boolean');
            }
            if (data.hasOwnProperty('summer')) {
                obj['summer'] = ApiClient.convertToType(data['summer'], 'Boolean');
            }
        }
        return obj;
    }
...
/**
 * Whether the course is taught during Term 1.
 * @member {Boolean} term_1
 */
TeachingPeriods.prototype['term_1'] = undefined;

/**
 * Whether the course is taught during Term 2.
 * @member {Boolean} term_2
 */
TeachingPeriods.prototype['term_2'] = undefined;

/**
 * Whether the course is taught during Term 3.
 * @member {Boolean} term_3
 */
TeachingPeriods.prototype['term_3'] = undefined;

/**
 * Whether the course is taught during Term 1 of the following academic year. This is used by admissions to calculate the end dates for non-standard programmes, and therefore is rare.
 * @member {Boolean} term_1_next_year
 */
TeachingPeriods.prototype['term_1_next_year'] = undefined;

/**
 * Whether the course timetabled during the summer holidays. This can happen in some Postgraduate and Medicine teaching arrangements, but is rare. Note that this is NOT the same as the UCL Summer School.
 * @member {Boolean} summer
 */
TeachingPeriods.prototype['summer'] = undefined;
