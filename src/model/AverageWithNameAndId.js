...
class AverageWithNameAndId {
    /**
     * Constructs a new <code>AverageWithNameAndId</code>.
     * @alias module:model/AverageWithNameAndId
     */
    constructor() { 
        
        AverageWithNameAndId.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AverageWithNameAndId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AverageWithNameAndId} obj Optional instance to populate.
     * @return {module:model/AverageWithNameAndId} The populated <code>AverageWithNameAndId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AverageWithNameAndId();
 ...
 */
AverageWithNameAndId.prototype['sensors_absent'] = undefined;

/**
 * The total number of used seats at time t.
 * @member {Number} sensors_total
 */
AverageWithNameAndId.prototype['sensors_total'] = undefined;

/**
 * Number of taken / occupied seats in that section of the library.
 * @member {Number} sensors_occupied
 */
AverageWithNameAndId.prototype['sensors_occupied'] = undefined;

/**
 * The name of the survey (library).
 * @member {String} name
 */
AverageWithNameAndId.prototype['name'] = undefined;

/**
 * ID of the library region (map).
 * @member {Number} id
 */
AverageWithNameAndId.prototype['id'] = undefined;
...
export default AverageWithNameAndId;
