    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('zones')) {
                obj['zones'] = ApiClient.convertToType(data['zones'], [LibcalZone]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20037.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/LibcalZone>} zones
 */
InlineResponse20037.prototype['zones'] = undefined;
