    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('equipment')) {
                obj['equipment'] = ApiClient.convertToType(data['equipment'], [Equipment]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse2008.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/Equipment>} equipment
 */
InlineResponse2008.prototype['equipment'] = undefined;
