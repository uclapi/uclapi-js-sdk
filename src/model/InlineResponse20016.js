...
import SurveyWithMaps from './SurveyWithMaps';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('surveys')) {
                obj['surveys'] = ApiClient.convertToType(data['surveys'], [SurveyWithMaps]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20016.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/SurveyWithMaps>} surveys
 */
InlineResponse20016.prototype['surveys'] = undefined;
