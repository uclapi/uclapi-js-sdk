...
class LocationCoordinates {
    /**
     * Constructs a new <code>LocationCoordinates</code>.
     * @alias module:model/LocationCoordinates
     */
    constructor() { 
        
        LocationCoordinates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LocationCoordinates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationCoordinates} obj Optional instance to populate.
     * @return {module:model/LocationCoordinates} The populated <code>LocationCoordinates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationCoordinates();
 ...
 * @member {String} lat
 */
LocationCoordinates.prototype['lat'] = undefined;

/**
 * Longitude of location
 * @member {String} lng
 */
LocationCoordinates.prototype['lng'] = undefined;
