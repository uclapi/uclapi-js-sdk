...
/**
 * The SvgGImage model module.
 * @module model/SvgGImage
 * @version 1.1.0
 */
class SvgGImage {
    /**
     * Constructs a new <code>SvgGImage</code>.
     * @alias module:model/SvgGImage
     */
    constructor() { 
        
        SvgGImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SvgGImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SvgGImage} obj Optional instance to populate.
     * @return {module:model/SvgGImage} The populated <code>SvgGImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SvgGImage();
            ...
            if (data.hasOwnProperty('xlink:href')) {
                obj['xlink:href'] = ApiClient.convertToType(data['xlink:href'], 'String');
            }
            if (data.hasOwnProperty('g')) {
                obj['g'] = ApiClient.convertToType(data['g'], [SeatImage]);
            }
        }
        return obj;
    }
 ...
 * @member {String} width
 */
SvgGImage.prototype['width'] = undefined;

/**
 * @member {String} height
 */
SvgGImage.prototype['height'] = undefined;

/**
 * @member {String} xlink:href
 */
SvgGImage.prototype['xlink:href'] = undefined;

/**
 * @member {Array.<module:model/SeatImage>} g
 */
SvgGImage.prototype['g'] = undefined;
