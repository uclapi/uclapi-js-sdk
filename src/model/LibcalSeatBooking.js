...
/**
 * The LibcalSeatBooking model module.
 * @module model/LibcalSeatBooking
 * @version 1.4.8
 */
class LibcalSeatBooking {
    /**
     * Constructs a new <code>LibcalSeatBooking</code>.
     * @alias module:model/LibcalSeatBooking
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LibcalSeatBooking</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalSeatBooking} obj Optional instance to populate.
     * @return {module:model/LibcalSeatBooking} The populated <code>LibcalSeatBooking</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalSeatBooking();
...
export default LibcalSeatBooking;
