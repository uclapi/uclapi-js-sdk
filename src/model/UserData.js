    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('upi')) {
                obj['upi'] = ApiClient.convertToType(data['upi'], 'String');
            }
            if (data.hasOwnProperty('scope_number')) {
                obj['scope_number'] = ApiClient.convertToType(data['scope_number'], 'Number');
            }
            if (data.hasOwnProperty('is_student')) {
                obj['is_student'] = ApiClient.convertToType(data['is_student'], 'Boolean');
            }
            if (data.hasOwnProperty('ucl_groups')) {
                obj['ucl_groups'] = ApiClient.convertToType(data['ucl_groups'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
UserData.prototype['ok'] = undefined;
...
/**
 * Full name of the user. Can be an empty string.
 * @member {String} full_name
 */
UserData.prototype['full_name'] = undefined;

/**
 * Department the user belongs to. Can be an empty string.
 * @member {String} department
 */
UserData.prototype['department'] = undefined;

/**
 * UCL username of the given user.
 * @member {String} cn
 */
UserData.prototype['cn'] = undefined;

/**
 * Given first name of the user. Can be an empty string.
 * @member {String} given_name
 */
UserData.prototype['given_name'] = undefined;

/**
 * Unique Person Identifier.
 * @member {String} upi
 */
UserData.prototype['upi'] = undefined;

/**
 * Scopes the application has access to on behalf of the user.
 * @member {Number} scope_number
 */
UserData.prototype['scope_number'] = undefined;

/**
 * Whether the user is a student in this academic year.
 * @member {Boolean} is_student
 */
UserData.prototype['is_student'] = undefined;

/**
 * A semi-colon delimited string of all UCL intranet groups that the user belongs to.
 * @member {String} ucl_groups
 */
UserData.prototype['ucl_groups'] = undefined;
