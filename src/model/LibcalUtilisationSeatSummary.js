...
/**
 * The LibcalUtilisationSeatSummary model module.
 * @module model/LibcalUtilisationSeatSummary
 * @version 1.4.9
 */
class LibcalUtilisationSeatSummary {
    /**
     * Constructs a new <code>LibcalUtilisationSeatSummary</code>.
     * @alias module:model/LibcalUtilisationSeatSummary
     */
    constructor() { 
        
        LibcalUtilisationSeatSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalUtilisationSeatSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalUtilisationSeatSummary} obj Optional instance to populate.
     * @return {module:model/LibcalUtilisationSeatSummary} The populated <code>LibcalUtilisationSeatSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalUtilisationSeatSummary();
...
/**
 * Number of active LibCal bookings of seats
 * @member {Number} active
 */
LibcalUtilisationSeatSummary.prototype['active'] = undefined;

/**
 * Number of LibCal seats available to be booked
 * @member {Number} bookable_count
 */
LibcalUtilisationSeatSummary.prototype['bookable_count'] = undefined;

/**
 * Total number of LibCal seats in the location
 * @member {Number} total
 */
LibcalUtilisationSeatSummary.prototype['total'] = undefined;
...
export default LibcalUtilisationSeatSummary;
