    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('survey_name')) {
                obj['survey_name'] = ApiClient.convertToType(data['survey_name'], 'String');
            }
            if (data.hasOwnProperty('survey_id')) {
                obj['survey_id'] = ApiClient.convertToType(data['survey_id'], 'Number');
            }
            if (data.hasOwnProperty('maps')) {
                obj['maps'] = ApiClient.convertToType(data['maps'], [MapWithSensors]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20013.prototype['ok'] = undefined;

/**
 * @member {String} survey_name
 */
InlineResponse20013.prototype['survey_name'] = undefined;

/**
 * @member {Number} survey_id
 */
InlineResponse20013.prototype['survey_id'] = undefined;

/**
 * @member {Array.<module:model/MapWithSensors>} maps
 */
InlineResponse20013.prototype['maps'] = undefined;
