    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bookings')) {
                obj['bookings'] = ApiClient.convertToType(data['bookings'], [LibcalSeatBooking]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20039.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/LibcalSeatBooking>} bookings
 */
InlineResponse20039.prototype['bookings'] = undefined;
