...
class Survey {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('staff_survey')) {
                obj['staff_survey'] = ApiClient.convertToType(data['staff_survey'], 'Boolean');
            }
            if (data.hasOwnProperty('maps')) {
                obj['maps'] = ApiClient.convertToType(data['maps'], [Object]);
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = SurveyLocation.constructFromObject(data['location']);
            }
        }
        return obj;
    }
...
/**
 * The library survey's ID. This is used later to identify individual libraries.
 * @member {Number} id
 */
...
/**
 * Whether the survey is active and working.
 * @member {Boolean} active
 */
Survey.prototype['active'] = undefined;

/**
 * Standard UCL opening time supplied by the backend. This field should NOT be trusted as information on when a particular library is open. This is usually set to 09:00.
 * @member {String} start_time
 */
Survey.prototype['start_time'] = undefined;

/**
 * Standard UCL closing time supplied by the backend. This field should NOT be trusted as information on when a particular library closes. This is usually set to 17:00.
 * @member {String} end_time
 */
Survey.prototype['end_time'] = undefined;

/**
 * Whether the survey represents a staff workspace (`true`) or a student work or study space (`false`). This is useful in apps where you set the `survey_filter` parameter to `all` and wish to do filtering of student and staff workspaces in your app or API as opposed to leaving the filtering to UCL API. By default, as `survey_filter` is set to `student` unless you specify otherwise, all workspaces will have this parameter set to `false`.
 * @member {Boolean} staff_survey
 */
Survey.prototype['staff_survey'] = undefined;

/**
 * List of maps corresponding to regions within the library's survey.
 * @member {Array.<Object>} maps
 */
Survey.prototype['maps'] = undefined;

/**
 * @member {module:model/SurveyLocation} location
 */
Survey.prototype['location'] = undefined;
