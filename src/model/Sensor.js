...
class Sensor {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('description_2')) {
                obj['description_2'] = ApiClient.convertToType(data['description_2'], 'String');
            }
            if (data.hasOwnProperty('floor')) {
                obj['floor'] = ApiClient.convertToType(data['floor'], 'String');
            }
            if (data.hasOwnProperty('y_pos')) {
                obj['y_pos'] = ApiClient.convertToType(data['y_pos'], 'String');
            }
            if (data.hasOwnProperty('description_3')) {
                obj['description_3'] = ApiClient.convertToType(data['description_3'], 'String');
            }
            if (data.hasOwnProperty('device_type')) {
                obj['device_type'] = ApiClient.convertToType(data['device_type'], 'String');
            }
            if (data.hasOwnProperty('host_address')) {
                obj['host_address'] = ApiClient.convertToType(data['host_address'], 'String');
            }
            if (data.hasOwnProperty('building_name')) {
                obj['building_name'] = ApiClient.convertToType(data['building_name'], 'String');
            }
            if (data.hasOwnProperty('room_description')) {
                obj['room_description'] = ApiClient.convertToType(data['room_description'], 'String');
            }
            if (data.hasOwnProperty('last_trigger_type')) {
                obj['last_trigger_type'] = ApiClient.convertToType(data['last_trigger_type'], 'String');
            }
            if (data.hasOwnProperty('survey_id')) {
                obj['survey_id'] = ApiClient.convertToType(data['survey_id'], 'String');
            }
            ...
            if (data.hasOwnProperty('survey_device_id')) {
                obj['survey_device_id'] = ApiClient.convertToType(data['survey_device_id'], 'String');
            }
            if (data.hasOwnProperty('share_id')) {
                obj['share_id'] = ApiClient.convertToType(data['share_id'], 'String');
            }
            if (data.hasOwnProperty('x_pos')) {
                obj['x_pos'] = ApiClient.convertToType(data['x_pos'], 'String');
            }
            if (data.hasOwnProperty('description_1')) {
                obj['description_1'] = ApiClient.convertToType(data['description_1'], 'String');
            }
            if (data.hasOwnProperty('hardware_id')) {
                obj['hardware_id'] = ApiClient.convertToType(data['hardware_id'], 'String');
            }
            if (data.hasOwnProperty('pir_address')) {
                obj['pir_address'] = ApiClient.convertToType(data['pir_address'], 'String');
            }
            if (data.hasOwnProperty('last_trigger_timestamp')) {
                obj['last_trigger_timestamp'] = ApiClient.convertToType(data['last_trigger_timestamp'], 'String');
            }
...
/**
 * Description 2.
 * @member {String} description_2
 */
Sensor.prototype['description_2'] = undefined;

/**
 * Whether the device is on the floor
 * @member {String} floor
 */
Sensor.prototype['floor'] = undefined;

/**
 * The Y coordinate position of the sensor on the map.
 * @member {String} y_pos
 */
Sensor.prototype['y_pos'] = undefined;

/**
 * Description 3.
 * @member {String} description_3
 */
Sensor.prototype['description_3'] = undefined;

/**
 * Type of seat. Usually this is Desk.
 * @member {String} device_type
 */
Sensor.prototype['device_type'] = undefined;

/**
 * Address of host.
 * @member {String} host_address
 */
Sensor.prototype['host_address'] = undefined;

/**
 * A short but human-readable name of the building that the sensor is in.
 * @member {String} building_name
 */
Sensor.prototype['building_name'] = undefined;

/**
 * A short but human-readable name of the room that the sensor is in.
 * @member {String} room_description
 */
Sensor.prototype['room_description'] = undefined;

/**
 * The last event the sensor recorded. Possible known values are Absent and Occupied, but this is not guaranteed. NB: only returned when return_states=true.
 * @member {String} last_trigger_type
 */
Sensor.prototype['last_trigger_type'] = undefined;

/**
 * The ID of the library/survey that was requested in the query parameter.
 * @member {String} survey_id
 */
Sensor.prototype['survey_id'] = undefined;

/**
 * The type of the room.
 * @member {String} room_type
 */
Sensor.prototype['room_type'] = undefined;

/**
 * The name of the room.
 * @member {String} room_name
 */
Sensor.prototype['room_name'] = undefined;

/**
 * The ID of the room.
 * @member {String} room_id
 */
Sensor.prototype['room_id'] = undefined;

/**
 * The location of this sensor.
 * @member {String} location
 */
Sensor.prototype['location'] = undefined;

/**
 * The ID of this survey device.
 * @member {String} survey_device_id
 */
Sensor.prototype['survey_device_id'] = undefined;

/**
 * The Share ID.
 * @member {String} share_id
 */
Sensor.prototype['share_id'] = undefined;

/**
 * The X coordinate position of the sensor on the map.
 * @member {String} x_pos
 */
Sensor.prototype['x_pos'] = undefined;

/**
 * @member {String} description_1
 */
Sensor.prototype['description_1'] = undefined;

/**
 * A unique ID for the sensor.
 * @member {String} hardware_id
 */
Sensor.prototype['hardware_id'] = undefined;

/**
 * PIR address.
 * @member {String} pir_address
 */
Sensor.prototype['pir_address'] = undefined;

/**
 * The last time that this sensor's update value was recorded. NB: only returned when return_states=true.
 * @member {String} last_trigger_timestamp
 */
Sensor.prototype['last_trigger_timestamp'] = undefined;

/**
 * Whether the seat is occupied or not. This takes into account UCL's thirty minute rule, so it's possible that the seat could have been marked as absent a few minutes ago, but this value is still set to true, as UCL allows students to leave their seat unattended for up to thirty minutes at a time (e.g. to use the bathroom or get food). Integrations that provide live seating information to students should use this value so as to have parity with the UCL Library seating policy and the UCL Library website. NB: only returned when return_states=true.
 * @member {Boolean} occupied
 */
Sensor.prototype['occupied'] = undefined;
