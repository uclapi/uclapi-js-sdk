...
/**
 * The SensorAverageSurvey model module.
 * @module model/SensorAverageSurvey
 * @version 1.4.4
 */
class SensorAverageSurvey {
    /**
     * Constructs a new <code>SensorAverageSurvey</code>.
     * @alias module:model/SensorAverageSurvey
     */
    constructor() { 
        
        SensorAverageSurvey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensorAverageSurvey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensorAverageSurvey} obj Optional instance to populate.
     * @return {module:model/SensorAverageSurvey} The populated <code>SensorAverageSurvey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensorAverageSurvey();
            ...
            if (data.hasOwnProperty('averages')) {
                obj['averages'] = ApiClient.convertToType(data['averages'], {'String': Average});
            }
        }
        return obj;
    }
 ...
 */
SensorAverageSurvey.prototype['survey_id'] = undefined;

/**
 * Name of survey location.
 * @member {String} name
 */
SensorAverageSurvey.prototype['name'] = undefined;

/**
 * @member {Object.<String, module:model/Average>} averages
 */
SensorAverageSurvey.prototype['averages'] = undefined;
...
export default SensorAverageSurvey;
