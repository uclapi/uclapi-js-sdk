...
/**
 * The LibcalLocationBase model module.
 * @module model/LibcalLocationBase
 * @version 1.4.10
 */
class LibcalLocationBase {
    /**
     * Constructs a new <code>LibcalLocationBase</code>.
     * @alias module:model/LibcalLocationBase
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LibcalLocationBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalLocationBase} obj Optional instance to populate.
     * @return {module:model/LibcalLocationBase} The populated <code>LibcalLocationBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalLocationBase();
...
export default LibcalLocationBase;
