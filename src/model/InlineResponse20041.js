    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bookings')) {
                obj['bookings'] = ApiClient.convertToType(data['bookings'], Object);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20041.prototype['ok'] = undefined;

/**
 * Will only be returned if there are errors
 * @member {Object} error
 */
InlineResponse20041.prototype['error'] = undefined;

/**
 * @member {Object} bookings
 */
InlineResponse20041.prototype['bookings'] = undefined;
