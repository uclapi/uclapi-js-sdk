...
import LibcalZone from './LibcalZone';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('zone')) {
                obj['zone'] = ApiClient.convertToType(data['zone'], LibcalZone);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20038.prototype['ok'] = undefined;

/**
 * Will be returned if there is an error retrieving the given LibCal space, e.g. if the space ID provided is invalid
 * @member {String} error
 */
InlineResponse20038.prototype['error'] = undefined;

/**
 * @member {module:model/LibcalZone} zone
 */
InlineResponse20038.prototype['zone'] = undefined;
