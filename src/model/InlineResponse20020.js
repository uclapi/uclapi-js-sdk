...
import InlineResponse20020Surveys from './InlineResponse20020Surveys';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('surveys')) {
                obj['surveys'] = InlineResponse20020Surveys.constructFromObject(data['surveys']);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20020.prototype['ok'] = undefined;

/**
 * @member {module:model/InlineResponse20020Surveys} surveys
 */
InlineResponse20020.prototype['surveys'] = undefined;
