...
class MapWithSensors {
    /**
     * Constructs a new <code>MapWithSensors</code>.
     * @alias module:model/MapWithSensors
     */
    constructor() { 
        
        MapWithSensors.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MapWithSensors</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MapWithSensors} obj Optional instance to populate.
     * @return {module:model/MapWithSensors} The populated <code>MapWithSensors</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MapWithSensors();
            ...
            if (data.hasOwnProperty('sensors')) {
                obj['sensors'] = ApiClient.convertToType(data['sensors'], {'String': Sensor});
            }
        }
        return obj;
    }
 ...
 * @member {Number} id
 */
MapWithSensors.prototype['id'] = undefined;

/**
 * The name of the mapped section of the library's survey, such as a level, room or wing.
 * @member {String} name
 */
MapWithSensors.prototype['name'] = undefined;

/**
 * The ID of the map's image. This can be used to download a CAD drawing of the map.
 * @member {Number} image_id
 */
MapWithSensors.prototype['image_id'] = undefined;

/**
 * @member {Object.<String, module:model/Sensor>} sensors
 */
MapWithSensors.prototype['sensors'] = undefined;
