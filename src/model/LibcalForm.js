...
/**
 * The LibcalForm model module.
 * @module model/LibcalForm
 * @version 1.4.10
 */
class LibcalForm {
    /**
     * Constructs a new <code>LibcalForm</code>.
     * @alias module:model/LibcalForm
     */
    constructor() { 
        
        LibcalForm.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalForm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalForm} obj Optional instance to populate.
     * @return {module:model/LibcalForm} The populated <code>LibcalForm</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalForm();
            ...
            if (data.hasOwnProperty('fields')) {
                obj['fields'] = ApiClient.convertToType(data['fields'], [LibcalFormField]);
            }
        }
        return obj;
    }
 ...
 * @member {Number} id
 */
LibcalForm.prototype['id'] = undefined;

/**
 * Name of the LibCal booking form
 * @member {String} name
 */
LibcalForm.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/LibcalFormField>} fields
 */
LibcalForm.prototype['fields'] = undefined;
