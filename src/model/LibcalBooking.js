...
/**
 * The LibcalBooking model module.
 * @module model/LibcalBooking
 * @version 1.4.7
 */
class LibcalBooking {
    /**
     * Constructs a new <code>LibcalBooking</code>.
     * @alias module:model/LibcalBooking
     */
    constructor() { 
        
        LibcalBooking.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalBooking</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalBooking} obj Optional instance to populate.
     * @return {module:model/LibcalBooking} The populated <code>LibcalBooking</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalBooking();
