...
/**
 * The LibcalUtilisationSpaceSummary model module.
 * @module model/LibcalUtilisationSpaceSummary
 * @version 1.4.10
 */
class LibcalUtilisationSpaceSummary {
    /**
     * Constructs a new <code>LibcalUtilisationSpaceSummary</code>.
     * @alias module:model/LibcalUtilisationSpaceSummary
     */
    constructor() { 
        
        LibcalUtilisationSpaceSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalUtilisationSpaceSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalUtilisationSpaceSummary} obj Optional instance to populate.
     * @return {module:model/LibcalUtilisationSpaceSummary} The populated <code>LibcalUtilisationSpaceSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalUtilisationSpaceSummary();

            if (data.hasOwnProperty('active')) {
                obj['active'] = ApiClient.convertToType(data['active'], 'Number');
            }
            if (data.hasOwnProperty('bookable_count')) {
                obj['bookable_count'] = ApiClient.convertToType(data['bookable_count'], 'Number');
            }
...
/**
 * Number of active LibCal bookings of spaces
 * @member {Number} active
 */
LibcalUtilisationSpaceSummary.prototype['active'] = undefined;

/**
 * Number of LibCal spaces available to be booked
 * @member {Number} bookable_count
 */
LibcalUtilisationSpaceSummary.prototype['bookable_count'] = undefined;

/**
 * Total number of LibCal spaces in the location
 * @member {Number} total
 */
LibcalUtilisationSpaceSummary.prototype['total'] = undefined;
...
export default LibcalUtilisationSpaceSummary;
