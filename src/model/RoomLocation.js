    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('coordinates')) {
                obj['coordinates'] = LocationCoordinates.constructFromObject(data['coordinates']);
            }
        }
        return obj;
    }
...
/**
 * Address represented as an array.
 * @member {Array.<String>} address
 */
RoomLocation.prototype['address'] = undefined;

/**
 * @member {module:model/LocationCoordinates} coordinates
 */
