...
import RoomLocationCoordinates from './RoomLocationCoordinates';

/**
 * The RoomLocation model module.
 * @module model/RoomLocation
 * @version 1.1.0
 */
class RoomLocation {
    /**
     * Constructs a new <code>RoomLocation</code>.
     * @alias module:model/RoomLocation
     */
    constructor() { 
        
        RoomLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RoomLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoomLocation} obj Optional instance to populate.
     * @return {module:model/RoomLocation} The populated <code>RoomLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoomLocation();

            if (data.hasOwnProperty('address')) {
                obj['address'] = ApiClient.convertToType(data['address'], ['String']);
            }
            if (data.hasOwnProperty('coordinates')) {
                obj['coordinates'] = RoomLocationCoordinates.constructFromObject(data['coordinates']);
            }
        }
        return obj;
    }
 ...
 */
RoomLocation.prototype['address'] = undefined;

/**
 * @member {module:model/RoomLocationCoordinates} coordinates
 */
RoomLocation.prototype['coordinates'] = undefined;
