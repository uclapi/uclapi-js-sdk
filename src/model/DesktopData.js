...
import DesktopDataLocation from './DesktopDataLocation';
...
class DesktopData {
    /**
     * Constructs a new <code>DesktopData</code>.
     * @alias module:model/DesktopData
     */
    constructor() { 
        
        DesktopData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DesktopData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DesktopData} obj Optional instance to populate.
     * @return {module:model/DesktopData} The populated <code>DesktopData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DesktopData();

            if (data.hasOwnProperty('room_status')) {
                obj['room_status'] = ApiClient.convertToType(data['room_status'], 'String');
            }
            if (data.hasOwnProperty('total_seats')) {
                obj['total_seats'] = ApiClient.convertToType(data['total_seats'], 'String');
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = DesktopDataLocation.constructFromObject(data['location']);
            }
            if (data.hasOwnProperty('free_seats')) {
                obj['free_seats'] = ApiClient.convertToType(data['free_seats'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {String} room_status
 */
DesktopData.prototype['room_status'] = undefined;

/**
 * Total number of computers available in the room.
 * @member {String} total_seats
 */
DesktopData.prototype['total_seats'] = undefined;

/**
 * @member {module:model/DesktopDataLocation} location
 */
DesktopData.prototype['location'] = undefined;

/**
 * Number of free seats in the room.
 * @member {String} free_seats
 */
DesktopData.prototype['free_seats'] = undefined;
