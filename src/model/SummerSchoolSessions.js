...
class SummerSchoolSessions {
    /**
     * Constructs a new <code>SummerSchoolSessions</code>.
     * @alias module:model/SummerSchoolSessions
     */
    constructor() { 
        
        SummerSchoolSessions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SummerSchoolSessions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SummerSchoolSessions} obj Optional instance to populate.
     * @return {module:model/SummerSchoolSessions} The populated <code>SummerSchoolSessions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SummerSchoolSessions();

            if (data.hasOwnProperty('session_1')) {
                obj['session_1'] = ApiClient.convertToType(data['session_1'], 'Boolean');
            }
            if (data.hasOwnProperty('session_2')) {
                obj['session_2'] = ApiClient.convertToType(data['session_2'], 'Boolean');
            }
        }
        return obj;
    }
...
/**
 * Whether the module is taught in the first summer school session of this academic year's summer. This will be false for all standard academic modules.
 * @member {Boolean} session_1
 */
SummerSchoolSessions.prototype['session_1'] = undefined;

/**
 * Whether the module is taught in the second summer school session of this academic year's summer. This will be false for all standard academic modules.
 * @member {Boolean} session_2
 */
SummerSchoolSessions.prototype['session_2'] = undefined;
...
export default SummerSchoolSessions;
