...
class InlineResponse2009 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('free_rooms')) {
                obj['free_rooms'] = ApiClient.convertToType(data['free_rooms'], [Room]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse2009.prototype['ok'] = undefined;
...
/**
 * @member {Array.<module:model/Room>} free_rooms
 */
InlineResponse2009.prototype['free_rooms'] = undefined;
