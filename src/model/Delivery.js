...
class Delivery {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fheq_level')) {
                obj['fheq_level'] = ApiClient.convertToType(data['fheq_level'], 'Number');
            }
            if (data.hasOwnProperty('is_undergraduate')) {
                obj['is_undergraduate'] = ApiClient.convertToType(data['is_undergraduate'], 'Boolean');
            }
...
/**
 * The level the course is taught at, and whether it is an undergraduate (true) or postgraduate (false) course.
 * @member {Number} fheq_level
 */
Delivery.prototype['fheq_level'] = undefined;

/**
 * Whether the course instance is for undergraduate (true) students or postgraduate (false) students.
 * @member {Boolean} is_undergraduate
 */
Delivery.prototype['is_undergraduate'] = undefined;

/**
 * The type of student and assessment pattern available for that course. There are five options: 'Campus-based, numeric mark scheme', 'Campus-based, non-numeric mark scheme', 'Distance learner, numeric mark scheme', 'Distance learner, non-numeric mark scheme' and 'MBBS Resit'.
 * @member {String} student_type
 */
Delivery.prototype['student_type'] = undefined;
