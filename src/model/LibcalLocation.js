...
/**
 * The LibcalLocation model module.
 * @module model/LibcalLocation
 * @version 1.4.7
 */
class LibcalLocation {
    /**
     * Constructs a new <code>LibcalLocation</code>.
     * @alias module:model/LibcalLocation
     * @implements module:model/LibcalLocationBase
     */
    constructor() { 
        LibcalLocationBase.initialize(this);
        LibcalLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalLocation} obj Optional instance to populate.
     * @return {module:model/LibcalLocation} The populated <code>LibcalLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalLocation();
            LibcalLocationBase.constructFromObject(data, obj);
...
/**
 * 1 if the location is publicly-bookable, 0 if it is not
 * @member {Number} public
 */
LibcalLocation.prototype['public'] = undefined;

/**
 * Additional details about the location, such as terms & conditions. May include HTML.
 * @member {String} terms
 */
LibcalLocation.prototype['terms'] = undefined;

/**
 * ID for the LibCal location in question
 * @member {Number} lid
 */
LibcalLocation.prototype['lid'] = undefined;

/**
 * Name of the LibCal location in question
 * @member {String} name
 */
LibcalLocation.prototype['name'] = undefined;


// Implement LibcalLocationBase interface:
/**
 * ID for the LibCal location in question
 * @member {Number} lid
 */
LibcalLocationBase.prototype['lid'] = undefined;
/**
 * Name of the LibCal location in question
 * @member {String} name
 */
LibcalLocationBase.prototype['name'] = undefined;




export default LibcalLocation;
