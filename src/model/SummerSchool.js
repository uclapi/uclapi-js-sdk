...
import SummerSchoolSessions from './SummerSchoolSessions';
...
class SummerSchool {
    /**
     * Constructs a new <code>SummerSchool</code>.
     * @alias module:model/SummerSchool
     */
    constructor() { 
        
        SummerSchool.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SummerSchool</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SummerSchool} obj Optional instance to populate.
     * @return {module:model/SummerSchool} The populated <code>SummerSchool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SummerSchool();

            if (data.hasOwnProperty('is_summer_school')) {
                obj['is_summer_school'] = ApiClient.convertToType(data['is_summer_school'], 'Boolean');
            }
            if (data.hasOwnProperty('sessions')) {
                obj['sessions'] = SummerSchoolSessions.constructFromObject(data['sessions']);
            }
        }
        return obj;
    }
...
/**
 * Whether the module is taught as part of the UCL Summer School (true) or standard academic teaching (false).
 * @member {Boolean} is_summer_school
 */
SummerSchool.prototype['is_summer_school'] = undefined;

/**
 * @member {module:model/SummerSchoolSessions} sessions
 */
SummerSchool.prototype['sessions'] = undefined;
