...
import AverageWithNameAndId from './AverageWithNameAndId';

/**
 * The SurveyWithMaps model module.
 * @module model/SurveyWithMaps
 * @version 1.4.6
 */
class SurveyWithMaps {
    /**
     * Constructs a new <code>SurveyWithMaps</code>.
     * @alias module:model/SurveyWithMaps
     */
    constructor() { 
        
        SurveyWithMaps.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SurveyWithMaps</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SurveyWithMaps} obj Optional instance to populate.
     * @return {module:model/SurveyWithMaps} The populated <code>SurveyWithMaps</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SurveyWithMaps();
            ...
            if (data.hasOwnProperty('sensors_absent')) {
                obj['sensors_absent'] = ApiClient.convertToType(data['sensors_absent'], 'Number');
            }
            if (data.hasOwnProperty('sensors_total')) {
                obj['sensors_total'] = ApiClient.convertToType(data['sensors_total'], 'Number');
            }
            if (data.hasOwnProperty('sensors_occupied')) {
                obj['sensors_occupied'] = ApiClient.convertToType(data['sensors_occupied'], 'Number');
            }
            if (data.hasOwnProperty('maps')) {
                obj['maps'] = ApiClient.convertToType(data['maps'], [AverageWithNameAndId]);
            }
        }
        return obj;
    }
...
/**
 * Name of the library region (map).
 * @member {String} name
 */
SurveyWithMaps.prototype['name'] = undefined;

/**
 * ID of the library region (map).
 * @member {Number} id
 */
SurveyWithMaps.prototype['id'] = undefined;

/**
 * Number of free seats in that section of the library.
 * @member {Number} sensors_absent
 */
SurveyWithMaps.prototype['sensors_absent'] = undefined;

/**
 * The total number of used seats at time t.
 * @member {Number} sensors_total
 */
SurveyWithMaps.prototype['sensors_total'] = undefined;

/**
 * Number of taken / occupied seats in that section of the library.
 * @member {Number} sensors_occupied
 */
SurveyWithMaps.prototype['sensors_occupied'] = undefined;

/**
 * @member {Array.<module:model/AverageWithNameAndId>} maps
 */
SurveyWithMaps.prototype['maps'] = undefined;
