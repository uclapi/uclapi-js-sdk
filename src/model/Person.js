...
/**
 * Since only staff are returned through this API, this should always be Staff.
 * @member {String} status
 */
Person.prototype['status'] = undefined;

/**
 * The department the member of staff works under.
 * @member {String} department
 */
Person.prototype['department'] = undefined;
