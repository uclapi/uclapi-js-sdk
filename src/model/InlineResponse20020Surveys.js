...
import HistoricalSurvey from './HistoricalSurvey';
...
class InlineResponse20020Surveys {
    /**
     * Constructs a new <code>InlineResponse20020Surveys</code>.
     * @alias module:model/InlineResponse20020Surveys
     */
    constructor() { 
        
        InlineResponse20020Surveys.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineResponse20020Surveys</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse20020Surveys} obj Optional instance to populate.
     * @return {module:model/InlineResponse20020Surveys} The populated <code>InlineResponse20020Surveys</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse20020Surveys();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [HistoricalSurvey]);
            }
        }
        return obj;
    }
 ...
 * @member {String} next
 */
InlineResponse20020Surveys.prototype['next'] = undefined;

/**
 * @member {String} previous
 */
InlineResponse20020Surveys.prototype['previous'] = undefined;

/**
 * @member {Number} count
 */
InlineResponse20020Surveys.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/HistoricalSurvey>} results
 */
InlineResponse20020Surveys.prototype['results'] = undefined;
...
export default InlineResponse20020Surveys;
