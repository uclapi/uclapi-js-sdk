...
/**
 * The type of equipment. Either Fixed Equipment (FE) or Fixed Feature (FF).
 * @member {String} type
 */
Equipment.prototype['type'] = undefined;

/**
 * What the piece of equipment actually is.
 * @member {String} description
 */
Equipment.prototype['description'] = undefined;

/**
 * The number of times this piece of equipment exists in the room.
 * @member {Number} units
 */
Equipment.prototype['units'] = undefined;
