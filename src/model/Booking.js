    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('weeknumber')) {
                obj['weeknumber'] = ApiClient.convertToType(data['weeknumber'], 'Number');
            }
 ...
 */
Booking.prototype['slotid'] = undefined;

/**
 * End time of the event.
 * @member {String} end_time
 */
Booking.prototype['end_time'] = undefined;

/**
 * Describes what the booking is. Could contain a module code (for example WIBRG005) or just the type of activity (for example Lecture).
 * @member {String} description
 */
Booking.prototype['description'] = undefined;

/**
 * The name of the room. It often includes the name of the site (building) as well.
 * @member {String} roomname
 */
Booking.prototype['roomname'] = undefined;

/**
 * Every room is inside a site (building). All sites have IDs.
 * @member {String} siteid
 */
Booking.prototype['siteid'] = undefined;

/**
 * The name of the person who made the booking. Substrings of the contact name can be used: Queries for Mark will include Mark Herbster. Sometimes, a society or student group may be the contact for a booking.
 * @member {String} contact
 */
Booking.prototype['contact'] = undefined;

/**
 * Timetabled week number.
 * @member {Number} weeknumber
 */
Booking.prototype['weeknumber'] = undefined;

/**
 * The room ID (not to be confused with the roomname).
 * @member {String} roomid
 */
Booking.prototype['roomid'] = undefined;

/**
 * Start time of the event.
 * @member {String} start_time
 */
Booking.prototype['start_time'] = undefined;

/**
 * Phone extension.
 * @member {String} phone
 */
Booking.prototype['phone'] = undefined;
