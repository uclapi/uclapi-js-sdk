...
/**
 * The LibcalSeat model module.
 * @module model/LibcalSeat
 * @version 1.4.2
 */
class LibcalSeat {
    /**
     * Constructs a new <code>LibcalSeat</code>.
     * @alias module:model/LibcalSeat
     */
    constructor() { 
        
        LibcalSeat.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalSeat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalSeat} obj Optional instance to populate.
     * @return {module:model/LibcalSeat} The populated <code>LibcalSeat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalSeat();
            ...
            if (data.hasOwnProperty('is_accessible')) {
                obj['is_accessible'] = ApiClient.convertToType(data['is_accessible'], 'Boolean');
            }
            if (data.hasOwnProperty('is_powered')) {
                obj['is_powered'] = ApiClient.convertToType(data['is_powered'], 'Boolean');
            }
 ...
 * @member {Number} id
 */
LibcalSeat.prototype['id'] = undefined;

/**
 * Name of the LibCal seat
 * @member {String} name
 */
LibcalSeat.prototype['name'] = undefined;

/**
 * Description provided for the LibCal seat. May contain HTML
 * @member {String} description
 */
LibcalSeat.prototype['description'] = undefined;

/**
 * Whether the seat is height-adjustable and hence accessible by the differently-abled
 * @member {Boolean} is_accessible
 */
LibcalSeat.prototype['is_accessible'] = undefined;

/**
 * Whether a power socket is available at the seat
 * @member {Boolean} is_powered
 */
LibcalSeat.prototype['is_powered'] = undefined;

/**
 * A URL pointing to an image of the seat. If none is available, an empty string will be returned
 * @member {String} image
 */
LibcalSeat.prototype['image'] = undefined;

/**
 * The current status of the seat
 * @member {Boolean} status
 */
LibcalSeat.prototype['status'] = undefined;
