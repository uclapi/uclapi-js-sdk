...
import LibcalPersonalSeatBooking from './LibcalPersonalSeatBooking';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bookings')) {
                obj['bookings'] = ApiClient.convertToType(data['bookings'], [LibcalPersonalSeatBooking]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20040.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/LibcalPersonalSeatBooking>} bookings
 */
InlineResponse20040.prototype['bookings'] = undefined;
