...
import LibcalReserveRequestBooking from './LibcalReserveRequestBooking';

/**
 * The LibcalReserveRequest model module.
 * @module model/LibcalReserveRequest
 * @version 1.4.10
 */
class LibcalReserveRequest {
    /**
     * Constructs a new <code>LibcalReserveRequest</code>.
     * @alias module:model/LibcalReserveRequest
     * @param start {String} Timestamp (in ISO 8601 format) at which this LibCal booking starts
     * @param test {Number} Whether or not this is a test booking. If set, the system will process the booking but will not actually make it. This is useful during development.
     */
    constructor(start, test) { 
        
        LibcalReserveRequest.initialize(this, start, test);
    }
     ...
     */
    static initialize(obj, start, test) { 
        obj['start'] = start;
        obj['test'] = test;
    }

    /**
     * Constructs a <code>LibcalReserveRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalReserveRequest} obj Optional instance to populate.
     * @return {module:model/LibcalReserveRequest} The populated <code>LibcalReserveRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalReserveRequest();
            ...
            if (data.hasOwnProperty('bookings')) {
                obj['bookings'] = ApiClient.convertToType(data['bookings'], [LibcalReserveRequestBooking]);
            }
        }
        return obj;
    }
 ...
 * @member {String} start
 */
LibcalReserveRequest.prototype['start'] = undefined;

/**
 * Whether or not this is a test booking. If set, the system will process the booking but will not actually make it. This is useful during development.
 * @member {Number} test
 */
LibcalReserveRequest.prototype['test'] = undefined;

/**
 * If the space to be booked has a nickname, then the nickname must be supplied here.
 * @member {String} nickname
 */
LibcalReserveRequest.prototype['nickname'] = undefined;

/**
 * @member {Array.<module:model/LibcalReserveRequestBooking>} bookings
 */
LibcalReserveRequest.prototype['bookings'] = undefined;
...
export default LibcalReserveRequest;
