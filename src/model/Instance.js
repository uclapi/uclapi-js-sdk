...
class Instance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('full_module_id')) {
                obj['full_module_id'] = ApiClient.convertToType(data['full_module_id'], 'String');
            }
            if (data.hasOwnProperty('class_size')) {
                obj['class_size'] = ApiClient.convertToType(data['class_size'], 'Number');
            }
            if (data.hasOwnProperty('delivery')) {
                obj['delivery'] = Delivery.constructFromObject(data['delivery']);
            }
            if (data.hasOwnProperty('periods')) {
                obj['periods'] = Period.constructFromObject(data['periods']);
            }
...
/**
 * The module code concatenated with the instance data. This instance data is defined by the UCL Academic Model Project, and it is expanded out within this section.
 * @member {String} full_module_id
 */
Instance.prototype['full_module_id'] = undefined;

/**
 * The maximum number of students in the module permitted in that instance. In this example, twelve undergraduates are permitted to take this module in their third year, but ninety postgraduates may take the module.
 * @member {Number} class_size
 */
Instance.prototype['class_size'] = undefined;

/**
 * @member {module:model/Delivery} delivery
 */
Instance.prototype['delivery'] = undefined;

/**
 * @member {module:model/Period} periods
 */
Instance.prototype['periods'] = undefined;

/**
 * A code that, when combined with a module code, forms the 'full_module_id' field above. This data is used to calculate the delivery and periods information that is also provided via JSON. Concatenating the module_id, a hyphen and the instance_code forms the full_module_id field.
 * @member {String} instance_code
 */
Instance.prototype['instance_code'] = undefined;
