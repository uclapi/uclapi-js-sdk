...
import LibcalSeatBooking from './LibcalSeatBooking';

/**
 * The LibcalPersonalSeatBooking model module.
 * @module model/LibcalPersonalSeatBooking
 * @version 1.4.7
 */
class LibcalPersonalSeatBooking {
    /**
     * Constructs a new <code>LibcalPersonalSeatBooking</code>.
     * @alias module:model/LibcalPersonalSeatBooking
     * @implements module:model/LibcalSeatBooking
     */
    constructor() { 
        LibcalSeatBooking.initialize(this);
        LibcalPersonalSeatBooking.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalPersonalSeatBooking</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalPersonalSeatBooking} obj Optional instance to populate.
     * @return {module:model/LibcalPersonalSeatBooking} The populated <code>LibcalPersonalSeatBooking</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalPersonalSeatBooking();
            LibcalSeatBooking.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('check_in_code')) {
                obj['check_in_code'] = ApiClient.convertToType(data['check_in_code'], 'String');
            }
            if (data.hasOwnProperty('eid')) {
                obj['eid'] = ApiClient.convertToType(data['eid'], 'Number');
            }
            if (data.hasOwnProperty('cid')) {
                obj['cid'] = ApiClient.convertToType(data['cid'], 'Number');
            }
            if (data.hasOwnProperty('lid')) {
                obj['lid'] = ApiClient.convertToType(data['lid'], 'Number');
            }
            ...
            if (data.hasOwnProperty('seat_id')) {
                obj['seat_id'] = ApiClient.convertToType(data['seat_id'], 'Number');
            }
            if (data.hasOwnProperty('seat_name')) {
                obj['seat_name'] = ApiClient.convertToType(data['seat_name'], 'String');
            }
...
/**
 * ID assigned to this LibCal booking
 * @member {String} book_id
 */
LibcalPersonalSeatBooking.prototype['book_id'] = undefined;

/**
 * First name of the user who booked this
 * @member {String} first_name
 */
LibcalPersonalSeatBooking.prototype['first_name'] = undefined;

/**
 * Last name of the user who booked this
 * @member {String} last_name
 */
LibcalPersonalSeatBooking.prototype['last_name'] = undefined;

/**
 * Email address of the user who booked this
 * @member {String} email
 */
LibcalPersonalSeatBooking.prototype['email'] = undefined;

/**
 * Email address of the user who booked this
 * @member {String} check_in_code
 */
LibcalPersonalSeatBooking.prototype['check_in_code'] = undefined;

/**
 * ID of this LibCal space
 * @member {Number} eid
 */
LibcalPersonalSeatBooking.prototype['eid'] = undefined;

/**
 * LibCal category ID denoting a category assigned to a particular space
 * @member {Number} cid
 */
LibcalPersonalSeatBooking.prototype['cid'] = undefined;

/**
 * LibCal Location ID
 * @member {Number} lid
 */
LibcalPersonalSeatBooking.prototype['lid'] = undefined;

/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking starts
 * @member {String} from_date
 */
LibcalPersonalSeatBooking.prototype['from_date'] = undefined;

/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking ends
 * @member {String} to_date
 */
LibcalPersonalSeatBooking.prototype['to_date'] = undefined;

/**
 * Timestamp (in ISO 8601 format) denoting when this LibCal booking was created
 * @member {String} created
 */
LibcalPersonalSeatBooking.prototype['created'] = undefined;

/**
 * Status of this LibCal booking
 * @member {String} status
 */
LibcalPersonalSeatBooking.prototype['status'] = undefined;

/**
 * Name of the LibCal location in question
 * @member {String} location_name
 */
LibcalPersonalSeatBooking.prototype['location_name'] = undefined;

/**
 * Name of the category
 * @member {String} category_name
 */
LibcalPersonalSeatBooking.prototype['category_name'] = undefined;

/**
 * Name of this LibCal space
 * @member {String} item_name
 */
LibcalPersonalSeatBooking.prototype['item_name'] = undefined;

/**
 * LibCal seat ID
 * @member {Number} seat_id
 */
LibcalPersonalSeatBooking.prototype['seat_id'] = undefined;

/**
 * Name of the LibCal seat
 * @member {String} seat_name
 */
LibcalPersonalSeatBooking.prototype['seat_name'] = undefined;

/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking was cancelled, if applicable
 * @member {String} cancelled
 */
LibcalPersonalSeatBooking.prototype['cancelled'] = undefined;


// Implement LibcalSeatBooking interface:
/**
 * ID of this LibCal space
 * @member {Number} eid
 */
LibcalSeatBooking.prototype['eid'] = undefined;
/**
 * LibCal category ID denoting a category assigned to a particular space
 * @member {Number} cid
 */
LibcalSeatBooking.prototype['cid'] = undefined;
/**
 * LibCal Location ID
 * @member {Number} lid
 */
LibcalSeatBooking.prototype['lid'] = undefined;
/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking starts
 * @member {String} from_date
 */
LibcalSeatBooking.prototype['from_date'] = undefined;
/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking ends
 * @member {String} to_date
 */
LibcalSeatBooking.prototype['to_date'] = undefined;
/**
 * Timestamp (in ISO 8601 format) denoting when this LibCal booking was created
 * @member {String} created
 */
LibcalSeatBooking.prototype['created'] = undefined;
/**
 * Status of this LibCal booking
 * @member {String} status
 */
LibcalSeatBooking.prototype['status'] = undefined;
/**
 * Name of the LibCal location in question
 * @member {String} location_name
 */
LibcalSeatBooking.prototype['location_name'] = undefined;
/**
 * Name of the category
 * @member {String} category_name
 */
LibcalSeatBooking.prototype['category_name'] = undefined;
/**
 * Name of this LibCal space
 * @member {String} item_name
 */
LibcalSeatBooking.prototype['item_name'] = undefined;
/**
 * LibCal seat ID
 * @member {Number} seat_id
 */
LibcalSeatBooking.prototype['seat_id'] = undefined;
/**
 * Name of the LibCal seat
 * @member {String} seat_name
 */
LibcalSeatBooking.prototype['seat_name'] = undefined;
/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking was cancelled, if applicable
 * @member {String} cancelled
 */
LibcalSeatBooking.prototype['cancelled'] = undefined;




export default LibcalPersonalSeatBooking;
