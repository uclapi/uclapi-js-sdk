...
/**
 * The LibcalReserveRequestBooking model module.
 * @module model/LibcalReserveRequestBooking
 * @version 1.4.8
 */
class LibcalReserveRequestBooking {
    /**
     * Constructs a new <code>LibcalReserveRequestBooking</code>.
     * Specify seat_id if booking a seat, otherwise omit it
     * @alias module:model/LibcalReserveRequestBooking
     * @param id {Number} ID of this LibCal space
     * @param to {String} Timestamp (in ISO 8601 format) at which this LibCal booking ends
     */
    constructor(id, to) { 
        
        LibcalReserveRequestBooking.initialize(this, id, to);
    }
     ...
     */
    static initialize(obj, id, to) { 
        obj['id'] = id;
        obj['to'] = to;
    }

    /**
     * Constructs a <code>LibcalReserveRequestBooking</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalReserveRequestBooking} obj Optional instance to populate.
     * @return {module:model/LibcalReserveRequestBooking} The populated <code>LibcalReserveRequestBooking</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalReserveRequestBooking();
 ...
 * @member {Number} id
 */
LibcalReserveRequestBooking.prototype['id'] = undefined;

/**
 * Timestamp (in ISO 8601 format) at which this LibCal booking ends
 * @member {String} to
 */
LibcalReserveRequestBooking.prototype['to'] = undefined;

/**
 * LibCal seat ID
 * @member {Number} seat_id
 */
LibcalReserveRequestBooking.prototype['seat_id'] = undefined;
...
export default LibcalReserveRequestBooking;
