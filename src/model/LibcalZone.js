...
/**
 * The LibcalZone model module.
 * @module model/LibcalZone
 * @version 1.4.7
 */
class LibcalZone {
    /**
     * Constructs a new <code>LibcalZone</code>.
     * @alias module:model/LibcalZone
     */
    constructor() { 
        
        LibcalZone.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalZone</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalZone} obj Optional instance to populate.
     * @return {module:model/LibcalZone} The populated <code>LibcalZone</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalZone();
 ...
 * @member {Number} id
 */
LibcalZone.prototype['id'] = undefined;

/**
 * Name of the LibCal zone
 * @member {String} name
 */
LibcalZone.prototype['name'] = undefined;
