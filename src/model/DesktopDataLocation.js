...
class DesktopDataLocation {
    /**
     * Constructs a new <code>DesktopDataLocation</code>.
     * @alias module:model/DesktopDataLocation
     */
    constructor() { 
        
        DesktopDataLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DesktopDataLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DesktopDataLocation} obj Optional instance to populate.
     * @return {module:model/DesktopDataLocation} The populated <code>DesktopDataLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DesktopDataLocation();
...
/**
 * Latitude of the location of the site.
 * @member {String} latitude
 */
DesktopDataLocation.prototype['latitude'] = undefined;

/**
 * Room ID.
 * @member {String} room_id
 */
DesktopDataLocation.prototype['room_id'] = undefined;

/**
 * Postcode of the location of the room.
 * @member {String} postcode
 */
DesktopDataLocation.prototype['postcode'] = undefined;

/**
 * Address of the room
 * @member {String} address
 */
DesktopDataLocation.prototype['address'] = undefined;

/**
 * Name of the room.
 * @member {String} room_name
 */
DesktopDataLocation.prototype['room_name'] = undefined;

/**
 * Name of the building.
 * @member {String} building_name
 */
DesktopDataLocation.prototype['building_name'] = undefined;

/**
 * Longitude of the location of the site.
 * @member {String} longitude
 */
DesktopDataLocation.prototype['longitude'] = undefined;
...
export default DesktopDataLocation;
