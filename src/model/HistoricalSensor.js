...
class HistoricalSensor {
    /**
     * Constructs a new <code>HistoricalSensor</code>.
     * @alias module:model/HistoricalSensor
     */
    constructor() { 
        
        HistoricalSensor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoricalSensor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoricalSensor} obj Optional instance to populate.
     * @return {module:model/HistoricalSensor} The populated <code>HistoricalSensor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoricalSensor();
            ...
            if (data.hasOwnProperty('sensor_id')) {
                obj['sensor_id'] = ApiClient.convertToType(data['sensor_id'], 'Number');
            }
            ...
            if (data.hasOwnProperty('survey_device_id')) {
                obj['survey_device_id'] = ApiClient.convertToType(data['survey_device_id'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
HistoricalSensor.prototype['survey_id'] = undefined;

/**
 * The ID of the sensor.
 * @member {Number} sensor_id
 */
HistoricalSensor.prototype['sensor_id'] = undefined;

/**
 * The hardware ID of the sensor.
 * @member {Number} hardware_id
 */
HistoricalSensor.prototype['hardware_id'] = undefined;

/**
 * The survey device ID of the sensor.
 * @member {Number} survey_device_id
 */
HistoricalSensor.prototype['survey_device_id'] = undefined;
...
export default HistoricalSensor;
