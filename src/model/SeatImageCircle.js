...
class SeatImageCircle {
    /**
     * Constructs a new <code>SeatImageCircle</code>.
     * @alias module:model/SeatImageCircle
     */
    constructor() { 
        
        SeatImageCircle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SeatImageCircle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeatImageCircle} obj Optional instance to populate.
     * @return {module:model/SeatImageCircle} The populated <code>SeatImageCircle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeatImageCircle();
 ...
 * @member {String} r
 */
SeatImageCircle.prototype['r'] = undefined;

/**
 * @member {String} fill
 */
SeatImageCircle.prototype['fill'] = undefined;
...
export default SeatImageCircle;
