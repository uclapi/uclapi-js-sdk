...
class HistoricalSurveyData {
    /**
     * Constructs a new <code>HistoricalSurveyData</code>.
     * @alias module:model/HistoricalSurveyData
     */
    constructor() { 
        
        HistoricalSurveyData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoricalSurveyData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoricalSurveyData} obj Optional instance to populate.
     * @return {module:model/HistoricalSurveyData} The populated <code>HistoricalSurveyData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoricalSurveyData();
            ...
            if (data.hasOwnProperty('averages')) {
                obj['averages'] = ApiClient.convertToType(data['averages'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
HistoricalSurveyData.prototype['sensor_id'] = undefined;

/**
 * The datetime of the sensor changing state.
 * @member {String} datetime
 */
HistoricalSurveyData.prototype['datetime'] = undefined;

/**
 * The state of the sensor (1=occupied; 0=absent; -1=unknown)
 * @member {Number} averages
 */
HistoricalSurveyData.prototype['averages'] = undefined;
...
export default HistoricalSurveyData;
