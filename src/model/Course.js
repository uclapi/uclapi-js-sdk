...
class Course {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('course_id')) {
                obj['course_id'] = ApiClient.convertToType(data['course_id'], 'String');
            }
 ...
 */
Course.prototype['course_name'] = undefined;

/**
 * The module code.
 * @member {String} course_id
 */
Course.prototype['course_id'] = undefined;

/**
 * Length of the course given in years.
 * @member {Number} years
 */
Course.prototype['years'] = undefined;
