...
/**
 * The Lecturer model module.
 * @module model/Lecturer
 * @version 1.4.10
 */
class Lecturer {
    /**
     * Constructs a new <code>Lecturer</code>.
     * @alias module:model/Lecturer
     */
    constructor() { 
        
        Lecturer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Lecturer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Lecturer} obj Optional instance to populate.
     * @return {module:model/Lecturer} The populated <code>Lecturer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Lecturer();
 ...
 * @member {String} name
 */
Lecturer.prototype['name'] = undefined;

/**
 * Human readable department name that owns the module.
 * @member {String} department_name
 */
Lecturer.prototype['department_name'] = undefined;

/**
 * Department code that this module comes under.
 * @member {String} department_id
 */
Lecturer.prototype['department_id'] = undefined;

/**
 * Email address for lecturer
 * @member {String} email
 */
Lecturer.prototype['email'] = undefined;
