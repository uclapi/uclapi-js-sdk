...
import HistoricalSurveyData from './HistoricalSurveyData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [HistoricalSurveyData]);
            }
        }
        return obj;
    }
 ...
 * @member {String} next
 */
InlineResponse20018Data.prototype['next'] = undefined;

/**
 * @member {String} previous
 */
InlineResponse20018Data.prototype['previous'] = undefined;

/**
 * @member {Array.<module:model/HistoricalSurveyData>} results
 */
InlineResponse20018Data.prototype['results'] = undefined;
