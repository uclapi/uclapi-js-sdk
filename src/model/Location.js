...
/**
 * Room name of the timetable event.
 * @member {String} name
 */
...
/**
 * Name of the site / building where the event is happening.
 * @member {String} site_name
 */
Location.prototype['site_name'] = undefined;

/**
 * Type of the room eg., Centrally Bookable (CB) or Departmentally Bookable (DB).
 * @member {String} type
 */
Location.prototype['type'] = undefined;

/**
 * Capacity of the room (e.g. how many seats are in a lecture theatre, or how many can be sat at tables in a flat space).
 * @member {Number} capacity
 */
Location.prototype['capacity'] = undefined;
