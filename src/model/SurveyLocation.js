...
import SurveyLocationCoordinates from './SurveyLocationCoordinates';
...
class SurveyLocation {
    /**
     * Constructs a new <code>SurveyLocation</code>.
     * @alias module:model/SurveyLocation
     */
    constructor() { 
        
        SurveyLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SurveyLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SurveyLocation} obj Optional instance to populate.
     * @return {module:model/SurveyLocation} The populated <code>SurveyLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SurveyLocation();

            if (data.hasOwnProperty('coordinates')) {
                obj['coordinates'] = SurveyLocationCoordinates.constructFromObject(data['coordinates']);
            }
...
/**
 * @member {module:model/SurveyLocationCoordinates} coordinates
 */
SurveyLocation.prototype['coordinates'] = undefined;

/**
 * List containing address lines for the survey location.
 * @member {Array.<String>} address
 */
SurveyLocation.prototype['address'] = undefined;
