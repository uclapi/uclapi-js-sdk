...
class Period {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('teaching_periods')) {
                obj['teaching_periods'] = TeachingPeriods.constructFromObject(data['teaching_periods']);
            }
            if (data.hasOwnProperty('year_long')) {
                obj['year_long'] = ApiClient.convertToType(data['year_long'], 'Boolean');
            }
            if (data.hasOwnProperty('lsr')) {
                obj['lsr'] = ApiClient.convertToType(data['lsr'], 'Boolean');
            }
            if (data.hasOwnProperty('summer_school')) {
                obj['summer_school'] = SummerSchool.constructFromObject(data['summer_school']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/TeachingPeriods} teaching_periods
 */
Period.prototype['teaching_periods'] = undefined;

/**
 * Whether the course is timetabled to last for an entire academic year.
 * @member {Boolean} year_long
 */
Period.prototype['year_long'] = undefined;

/**
 * Whether the module is timetabled during the Late Summer Resit period. This is used internally by Examinations to timetable Late Summer Assessments (LSAs).
 * @member {Boolean} lsr
 */
Period.prototype['lsr'] = undefined;

/**
 * @member {module:model/SummerSchool} summer_school
 */
Period.prototype['summer_school'] = undefined;
