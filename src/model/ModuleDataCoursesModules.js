...
class ModuleDataCoursesModules {
    /**
     * Constructs a new <code>ModuleDataCoursesModules</code>.
     * @alias module:model/ModuleDataCoursesModules
     */
    constructor() { 
        
        ModuleDataCoursesModules.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModuleDataCoursesModules</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModuleDataCoursesModules} obj Optional instance to populate.
     * @return {module:model/ModuleDataCoursesModules} The populated <code>ModuleDataCoursesModules</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModuleDataCoursesModules();
 ...
 */
ModuleDataCoursesModules.prototype['module_id'] = undefined;

/**
 * Module name.
 * @member {String} name
 */
ModuleDataCoursesModules.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/Instance>} instances
 */
ModuleDataCoursesModules.prototype['instances'] = undefined;
...
export default ModuleDataCoursesModules;
