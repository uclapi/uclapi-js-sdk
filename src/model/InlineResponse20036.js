...
import LibcalSeat from './LibcalSeat';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('seat')) {
                obj['seat'] = LibcalSeat.constructFromObject(data['seat']);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20036.prototype['ok'] = undefined;

/**
 * @member {module:model/LibcalSeat} seat
 */
InlineResponse20036.prototype['seat'] = undefined;
