...
import HistoricalSensor from './HistoricalSensor';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [HistoricalSensor]);
            }
        }
        return obj;
    }
 ...
 * @member {String} next
 */
InlineResponse20019Data.prototype['next'] = undefined;

/**
 * @member {String} previous
 */
InlineResponse20019Data.prototype['previous'] = undefined;

/**
 * @member {Number} count
 */
InlineResponse20019Data.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/HistoricalSensor>} results
 */
InlineResponse20019Data.prototype['results'] = undefined;
