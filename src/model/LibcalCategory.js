...
/**
 * The LibcalCategory model module.
 * @module model/LibcalCategory
 * @version 1.4.8
 */
class LibcalCategory {
    /**
     * Constructs a new <code>LibcalCategory</code>.
     * @alias module:model/LibcalCategory
     */
    constructor() { 
        
        LibcalCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LibcalCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LibcalCategory} obj Optional instance to populate.
     * @return {module:model/LibcalCategory} The populated <code>LibcalCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LibcalCategory();
 ...
 * @member {Number} cid
 */
LibcalCategory.prototype['cid'] = undefined;

/**
 * LibCal booking form ID
 * @member {Number} formid
 */
LibcalCategory.prototype['formid'] = undefined;

/**
 * Name of the category
 * @member {String} name
 */
LibcalCategory.prototype['name'] = undefined;

/**
 * 1 if the category of spaces is publicly-bookable, 0 if it is not
 * @member {Number} public
 */
LibcalCategory.prototype['public'] = undefined;
