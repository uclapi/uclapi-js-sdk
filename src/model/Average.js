...
class Average {
    /**
     * Constructs a new <code>Average</code>.
     * @alias module:model/Average
     */
    constructor() { 
        
        Average.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Average</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Average} obj Optional instance to populate.
     * @return {module:model/Average} The populated <code>Average</code> instance.
     */
...
/**
 * The average number of free seats at time t.
 * @member {Number} sensors_absent
 */
Average.prototype['sensors_absent'] = undefined;

/**
 * The total number of used seats at time t.
 * @member {Number} sensors_total
 */
Average.prototype['sensors_total'] = undefined;

/**
 * The average number of used seats at time t.
 * @member {Number} sensors_occupied
 */
Average.prototype['sensors_occupied'] = undefined;
