...
import SeatImageCircle from './SeatImageCircle';
...
class SeatImage {
    /**
     * Constructs a new <code>SeatImage</code>.
     * @alias module:model/SeatImage
     */
    constructor() { 
        
        SeatImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SeatImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeatImage} obj Optional instance to populate.
     * @return {module:model/SeatImage} The populated <code>SeatImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeatImage();

            if (data.hasOwnProperty('transform')) {
                obj['transform'] = ApiClient.convertToType(data['transform'], 'String');
            }
            if (data.hasOwnProperty('circle')) {
                obj['circle'] = SeatImageCircle.constructFromObject(data['circle']);
            }
        }
        return obj;
    }
 ...
 */
SeatImage.prototype['transform'] = undefined;

/**
 * @member {module:model/SeatImageCircle} circle
 */
SeatImage.prototype['circle'] = undefined;
