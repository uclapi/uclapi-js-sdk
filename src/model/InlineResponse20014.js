...
import SensorAverageSurvey from './SensorAverageSurvey';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('surveys')) {
                obj['surveys'] = ApiClient.convertToType(data['surveys'], [SensorAverageSurvey]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} ok
 */
InlineResponse20014.prototype['ok'] = undefined;

/**
 * @member {Array.<module:model/SensorAverageSurvey>} surveys
 */
InlineResponse20014.prototype['surveys'] = undefined;
