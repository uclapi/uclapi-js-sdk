...
class HistoricalSurvey {
    /**
     * Constructs a new <code>HistoricalSurvey</code>.
     * @alias module:model/HistoricalSurvey
     */
    constructor() { 
        
        HistoricalSurvey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoricalSurvey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoricalSurvey} obj Optional instance to populate.
     * @return {module:model/HistoricalSurvey} The populated <code>HistoricalSurvey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoricalSurvey();

            if (data.hasOwnProperty('survey_id')) {
                obj['survey_id'] = ApiClient.convertToType(data['survey_id'], 'Number');
            }
...
/**
 * The ID of the survey location.
 * @member {Number} survey_id
 */
HistoricalSurvey.prototype['survey_id'] = undefined;

/**
 * The name of the survey location
 * @member {String} name
 */
HistoricalSurvey.prototype['name'] = undefined;

/**
 * The start datetime of the survey location.
 * @member {String} start_datetime
 */
HistoricalSurvey.prototype['start_datetime'] = undefined;

/**
 * The end datetime of the survey location.
 * @member {String} end_datetime
 */
HistoricalSurvey.prototype['end_datetime'] = undefined;

/**
 * If the survey location is currently active (i.e., collecting new data).
 * @member {Boolean} active
 */
HistoricalSurvey.prototype['active'] = undefined;

/**
 * The last time this survey location was updated.
 * @member {String} last_updated
 */
HistoricalSurvey.prototype['last_updated'] = undefined;
