...
/**
 * The SurveyLocationCoordinates model module.
 * @module model/SurveyLocationCoordinates
 * @version 1.4.8
 */
class SurveyLocationCoordinates {
    /**
     * Constructs a new <code>SurveyLocationCoordinates</code>.
     * Object containing a latitude and longitude.
     * @alias module:model/SurveyLocationCoordinates
     */
    constructor() { 
        
        SurveyLocationCoordinates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SurveyLocationCoordinates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SurveyLocationCoordinates} obj Optional instance to populate.
     * @return {module:model/SurveyLocationCoordinates} The populated <code>SurveyLocationCoordinates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SurveyLocationCoordinates();
...
/**
 * Latitude of the survey location.
 * @member {String} lat
 */
SurveyLocationCoordinates.prototype['lat'] = undefined;

/**
 * Longitude of the survey location.
 * @member {String} lng
 */
SurveyLocationCoordinates.prototype['lng'] = undefined;
...
export default SurveyLocationCoordinates;
