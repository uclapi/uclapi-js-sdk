...
export default class RoomBookingsApi {
    ...
    /**
    * Constructs a new RoomBookingsApi. 
    * @alias module:api/RoomBookingsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the roombookingsBookingsGet operation.
     * @callback module:api/RoomBookingsApi~roombookingsBookingsGetCallback
     ...
     * @param {String} opts.roomname Every site (building) has a name. In some cases this is contained in the roomname as well.
     * @param {String} opts.roomid The room ID (not to be confused with the roomname).
     * @param {String} opts.startDatetime Start datetime of the booking. Returns bookings with a start_datetime after the one supplied. Follows the ISO 8601 formatting standard.
     * @param {String} opts.endDatetime End datetime of the booking. Returns bookings with an end_datetime before the one supplied. Follows the ISO 8601 formatting standard.
     * @param {String} opts._date Date of the bookings you need, in the format YYYYMMDD. Returns bookings occurring on this day. This query parameter is only considered when end_datetime and start_datetime are not supplied.
     * @param {String} opts.siteid Every room is inside a site (building). All sites have IDs.
     * @param {String} opts.description Describes what the booking is. Could contain a module code (for example WIBRG005) or just the type of activity (for example Lecture).
     * @param {String} opts.contact The name of the person who made the booking. Substrings of the contact name can be used, Queries for Mark will include Mark Herbster. Sometimes, a society or student group may be the contact for a booking.
     * @param {Number} opts.resultsPerPage Number of bookings returned per page. Maximum allowed value is 1000. Defaults to 1000.
     * @param {module:api/RoomBookingsApi~roombookingsBookingsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2007}
     */
    roombookingsBookingsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the roombookingsEquipmentGet operation.
     * @callback module:api/RoomBookingsApi~roombookingsEquipmentGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.roomid The room ID (not to be confused with the roomname).
     * @param {String} opts.siteid Every room is inside a site (building). All sites have IDs.
     * @param {module:api/RoomBookingsApi~roombookingsEquipmentGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2008}
     */
    roombookingsEquipmentGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the roombookingsFreeroomsGet operation.
     * @callback module:api/RoomBookingsApi~roombookingsFreeroomsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.startDatetime Start datetime of the booking. Returns bookings with a start_datetime after the one supplied. Follows the ISO 8601 formatting standard.
     * @param {String} opts.endDatetime End datetime of the booking. Returns bookings with an end_datetime before the one supplied. Follows the ISO 8601 formatting standard.
     * @param {module:api/RoomBookingsApi~roombookingsFreeroomsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2009}
     */
    roombookingsFreeroomsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the roombookingsRoomsGet operation.
     * @callback module:api/RoomBookingsApi~roombookingsRoomsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.roomid The room ID (not to be confused with the roomname).
     * @param {String} opts.siteid Every room is inside a site (building). All sites have IDs.
     * @param {String} opts.sitename Every site (building) has a name. In some cases this is contained in the roomname as well.
     * @param {String} opts.classification The room type ID.
     * @param {String} opts.capacity Every room has a set capacity of how many people can fit inside it. When supplied, all rooms with the given capacity or greater will be returned.
     * @param {module:api/RoomBookingsApi~roombookingsRoomsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2006}
     */
    roombookingsRoomsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
