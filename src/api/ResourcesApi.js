...
export default class ResourcesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resourcesDesktopsGet operation.
     * @callback module:api/ResourcesApi~resourcesDesktopsGetCallback
     ...
     * @param {module:api/ResourcesApi~resourcesDesktopsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20011}
     */
    resourcesDesktopsGet(callback) {
      let postBody = null;
