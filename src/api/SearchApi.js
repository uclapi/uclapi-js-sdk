...
export default class SearchApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the searchPeopleGet operation.
     * @callback module:api/SearchApi~searchPeopleGetCallback
     ...
     * @param {String} query Name of the person you are searching for.
     * @param {module:api/SearchApi~searchPeopleGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20010}
     */
    searchPeopleGet(query, callback) {
      let postBody = null;
      // verify the required parameter 'query' is set
      if (query === undefined || query === null) {
        throw new Error("Missing the required parameter 'query' when calling searchPeopleGet");
      }
